...
#elif defined (__SDCC_stm8) || defined (__SDCC_sm83) || defined (__SDCC_hc08) || defined (__SDCC_s08) || defined (__SDCC_f8) || defined (__SDCC_f8l) || defined (__SDCC_i8080) || defined (__SDCC_i8085)
typedef unsigned char jmp_buf[4]; /* 2 for the stack pointer, 2 for the return address. (8080/8085 have no frame pointer.) */
