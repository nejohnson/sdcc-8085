...
typedef enum
{
  ...
  /* Is in direct space */
  AOP_DIR,
  /* AOP_FDIR ("far direct space") removed: i8080/i8085 has no __far at
...
bool i8085_IsReturned(const char *what);
...
bool i8085_IsRegArg(struct sym_link *ftype, int i, const char *what);
