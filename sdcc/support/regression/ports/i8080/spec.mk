# Regression test specification for the Intel 8080 target running with uCsim
...
ifdef SDCC_BIN_PATH
  ...
  # Vendor as8085, not sdasz80 - the i8080 port shares the i8085 backend's
  # vendor ASxxxx toolchain (see src/i8085/main.c _i808xVendorAsmCmd).
  AS = $(WINE) $(top_builddir)/bin/as8085$(EXEEXT)
ifndef CROSSCOMPILING
  SDCCFLAGS += --nostdinc -I$(top_srcdir)
  LINKFLAGS += --nostdlib -L$(top_builddir)/device/lib/build/i8080
endif
endif
...
SDCCFLAGS += -mi8080 --less-pedantic --code-loc 0x0200 --data-loc 0x8000 --i-code-in-asm
LINKFLAGS += i8080.lib
