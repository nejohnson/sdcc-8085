...
# built with the undocumented instructions and flags enabled. Uses the
# separate undocumented library variant (device/lib/build/i8085-undoc).
...
ifndef CROSSCOMPILING
  ...
  LINKFLAGS += --nostdlib -L$(top_builddir)/device/lib/build/i8085-undoc
endif
endif
...
SDCCFLAGS += -mi8085 --allow-undocumented-instructions --less-pedantic --code-loc 0x0200 --data-loc 0x8000 --i-code-in-asm
LINKFLAGS += i8085.lib
