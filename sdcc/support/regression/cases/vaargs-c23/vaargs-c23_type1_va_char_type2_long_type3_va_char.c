...
#if (__STDC_VERSION_STDARG_H__ >= 202311L)
#ifndef __SDCC_pic16
    LOG(("First arg: %u\n", returnFirstArg((va_char)123, (long)45, (va_char)67)));
    ASSERT(returnFirstArg((va_char)123, (long)45, (va_char)67) == (va_char)123);
    ASSERT(returnFirstArg((va_char)-123, (long)45, (va_char)67) == (va_char)-123);
#if !defined( __SDCC_pdk13) && !defined( __SDCC_pdk14) // Lack of memory
    ASSERT(returnSecondArg((va_char)1, (long)-23, (va_char)64) == (long)-23);
    ASSERT(returnSecondArg((va_char)1, (long)8, (va_char)64) == (long)8);
    
    ASSERT(returnSecondArgCopy((va_char)1, (long)-23, (va_char)64) == (long)-23);
    ASSERT(returnSecondArgCopy((va_char)1, (long)8, (va_char)64) == (long)8);

    ASSERT(returnThirdArg((va_char)-33, (long)-34, (va_char)-35) == (va_char)-35);
    ASSERT(returnThirdArg((va_char)-33, (long)-34, (va_char)35) == (va_char)35);
#endif
#endif
#endif
...
__getSuiteName(void)
{
  return "vaargs-c23_type1_va_char_type2_long_type3_va_char";
}
