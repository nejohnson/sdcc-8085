...
#if (__STDC_VERSION_STDARG_H__ >= 202311L)
#ifndef __SDCC_pic16
    LOG(("First arg: %u\n", returnFirstArg((va_char)123, (va_char)45, (int)67)));
    ASSERT(returnFirstArg((va_char)123, (va_char)45, (int)67) == (va_char)123);
    ASSERT(returnFirstArg((va_char)-123, (va_char)45, (int)67) == (va_char)-123);
#if !defined( __SDCC_pdk13) && !defined( __SDCC_pdk14) // Lack of memory
    ASSERT(returnSecondArg((va_char)1, (va_char)-23, (int)64) == (va_char)-23);
    ASSERT(returnSecondArg((va_char)1, (va_char)8, (int)64) == (va_char)8);
    
    ASSERT(returnSecondArgCopy((va_char)1, (va_char)-23, (int)64) == (va_char)-23);
    ASSERT(returnSecondArgCopy((va_char)1, (va_char)8, (int)64) == (va_char)8);

    ASSERT(returnThirdArg((va_char)-33, (va_char)-34, (int)-35) == (int)-35);
    ASSERT(returnThirdArg((va_char)-33, (va_char)-34, (int)35) == (int)35);
#endif
#endif
#endif
...
__getSuiteName(void)
{
  return "vaargs-c23_type1_va_char_type2_va_char_type3_int";
}
