...
#if (__STDC_VERSION_STDARG_H__ >= 202311L)
#ifndef __SDCC_pic16
    LOG(("First arg: %u\n", returnFirstArg((int)123, (long)45, (int)67)));
    ASSERT(returnFirstArg((int)123, (long)45, (int)67) == (int)123);
    ASSERT(returnFirstArg((int)-123, (long)45, (int)67) == (int)-123);
#if !defined( __SDCC_pdk13) && !defined( __SDCC_pdk14) // Lack of memory
    ASSERT(returnSecondArg((int)1, (long)-23, (int)64) == (long)-23);
    ASSERT(returnSecondArg((int)1, (long)8, (int)64) == (long)8);
    
    ASSERT(returnSecondArgCopy((int)1, (long)-23, (int)64) == (long)-23);
    ASSERT(returnSecondArgCopy((int)1, (long)8, (int)64) == (long)8);

    ASSERT(returnThirdArg((int)-33, (long)-34, (int)-35) == (int)-35);
    ASSERT(returnThirdArg((int)-33, (long)-34, (int)35) == (int)35);
#endif
#endif
#endif
...
__getSuiteName(void)
{
  return "vaargs-c23_type1_int_type2_long_type3_int";
}
