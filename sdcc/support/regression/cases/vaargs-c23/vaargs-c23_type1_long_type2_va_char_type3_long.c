...
#if (__STDC_VERSION_STDARG_H__ >= 202311L)
#ifndef __SDCC_pic16
    LOG(("First arg: %u\n", returnFirstArg((long)123, (va_char)45, (long)67)));
    ASSERT(returnFirstArg((long)123, (va_char)45, (long)67) == (long)123);
    ASSERT(returnFirstArg((long)-123, (va_char)45, (long)67) == (long)-123);
#if !defined( __SDCC_pdk13) && !defined( __SDCC_pdk14) // Lack of memory
    ASSERT(returnSecondArg((long)1, (va_char)-23, (long)64) == (va_char)-23);
    ASSERT(returnSecondArg((long)1, (va_char)8, (long)64) == (va_char)8);
    
    ASSERT(returnSecondArgCopy((long)1, (va_char)-23, (long)64) == (va_char)-23);
    ASSERT(returnSecondArgCopy((long)1, (va_char)8, (long)64) == (va_char)8);

    ASSERT(returnThirdArg((long)-33, (va_char)-34, (long)-35) == (long)-35);
    ASSERT(returnThirdArg((long)-33, (va_char)-34, (long)35) == (long)35);
#endif
#endif
#endif
...
__getSuiteName(void)
{
  return "vaargs-c23_type1_long_type2_va_char_type3_long";
}
