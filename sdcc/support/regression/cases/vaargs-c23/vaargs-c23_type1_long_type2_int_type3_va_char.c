...
#if (__STDC_VERSION_STDARG_H__ >= 202311L)
#ifndef __SDCC_pic16
    LOG(("First arg: %u\n", returnFirstArg((long)123, (int)45, (va_char)67)));
    ASSERT(returnFirstArg((long)123, (int)45, (va_char)67) == (long)123);
    ASSERT(returnFirstArg((long)-123, (int)45, (va_char)67) == (long)-123);
#if !defined( __SDCC_pdk13) && !defined( __SDCC_pdk14) // Lack of memory
    ASSERT(returnSecondArg((long)1, (int)-23, (va_char)64) == (int)-23);
    ASSERT(returnSecondArg((long)1, (int)8, (va_char)64) == (int)8);
    
    ASSERT(returnSecondArgCopy((long)1, (int)-23, (va_char)64) == (int)-23);
    ASSERT(returnSecondArgCopy((long)1, (int)8, (va_char)64) == (int)8);

    ASSERT(returnThirdArg((long)-33, (int)-34, (va_char)-35) == (va_char)-35);
    ASSERT(returnThirdArg((long)-33, (int)-34, (va_char)35) == (va_char)35);
#endif
#endif
#endif
...
__getSuiteName(void)
{
  return "vaargs-c23_type1_long_type2_int_type3_va_char";
}
