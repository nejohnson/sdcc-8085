...
__runSuite(void)
{
  __prints("Running testSimpleStructAssignment\n");
  testSimpleStructAssignment();
  __prints("Running testTransitiveStructAssignment\n");
  testTransitiveStructAssignment();
  __prints("Running testSimpleUnionAssignment\n");
  testSimpleUnionAssignment();
  __prints("Running testTransitiveUnionAssignment\n");
  testTransitiveUnionAssignment();
  __prints("Running testUnintendedDoubleEval\n");
  testUnintendedDoubleEval();
}
