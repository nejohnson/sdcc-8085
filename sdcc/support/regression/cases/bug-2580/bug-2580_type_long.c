...
unsigned long game_menu_sel;
unsigned long s_lin1;

void game_menu_back(unsigned long f_start) __z88dk_fastcall
{
    game_menu_sel = 0;
    s_lin1 = f_start;
}
...
void testBug(void)
{
    ...
    ASSERT(s_lin1 == (unsigned long)0x55aaa5a5ul);
}
