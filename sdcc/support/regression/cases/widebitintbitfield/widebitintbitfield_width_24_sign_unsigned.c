...
#if __SDCC_BITINT_MAXWIDTH >= 24 && (24 <= 40 || !defined(__SDCC_pdk13)) // Lack of memory for pdk13. TODO: When we can regression-test in --std-c23 mode, use the standard macro from limits.h instead!
...
__getSuiteName(void)
{
  return "widebitintbitfield_width_24_sign_unsigned";
}
