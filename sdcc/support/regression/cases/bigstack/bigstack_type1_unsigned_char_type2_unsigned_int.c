...
void f(unsigned char par1, unsigned int par2)
{
...
testStack(void)
{
	...
	ASSERT (int2 == (unsigned int)42);
	f(0xa5a5a5, 0x5a5a5a);
	ASSERT (int1 == (unsigned char)0xa5a5a5);
	ASSERT (int2 == (unsigned int)0x5a5a5a);
}
...
__getSuiteName(void)
{
  return "bigstack_type1_unsigned_char_type2_unsigned_int";
}
