...
void f(unsigned char par1, unsigned long par2)
{
...
{
	f(23, 42);
	ASSERT (int1 == (unsigned char)23);
	ASSERT (int2 == (unsigned long)42);
	f(0xa5a5a5, 0x5a5a5a);
	ASSERT (int1 == (unsigned char)0xa5a5a5);
	ASSERT (int2 == (unsigned long)0x5a5a5a);
}
...
__getSuiteName(void)
{
  return "bigstack_type1_unsigned_char_type2_unsigned_long";
}
