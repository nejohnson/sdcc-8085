...
void f(unsigned int par1, unsigned long par2)
{
...
{
	f(23, 42);
	ASSERT (int1 == (unsigned int)23);
	ASSERT (int2 == (unsigned long)42);
	f(0xa5a5a5, 0x5a5a5a);
	ASSERT (int1 == (unsigned int)0xa5a5a5);
...
__getSuiteName(void)
{
  return "bigstack_type1_unsigned_int_type2_unsigned_long";
}
