...
bool LogicalOr1(signed char a, signed char b)
{
  return (a||b);
}

bool LogicalOr2(signed char a, signed char b)
{
  if(a|b)
    return true;
  else
...
bool LogicalAnd1(signed char a, signed char b)
{
  return (a&&b);
}

bool LogicalAnd2(signed char a, signed char b)
{
  if(a&b)
    return true;
  else
...
bool LogicalXor2(signed char a, signed char b)
{
  if(a^b)
    return true;
  else
...
testLogicalOr(void)
{
  ...
  for(i=0; i<(sizeof(signed char)*8); i++)
    {
      var=1ULL<<i;
...
__getSuiteName(void)
{
  return "logical_ops_type_signed_char";
}
