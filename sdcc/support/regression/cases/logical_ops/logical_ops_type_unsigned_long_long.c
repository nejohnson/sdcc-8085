...
bool LogicalOr1(unsigned long long a, unsigned long long b)
{
  return (a||b);
}

bool LogicalOr2(unsigned long long a, unsigned long long b)
{
  if(a|b)
    return true;
  else
...
bool LogicalAnd1(unsigned long long a, unsigned long long b)
{
  return (a&&b);
}

bool LogicalAnd2(unsigned long long a, unsigned long long b)
{
  if(a&b)
    return true;
  else
...
bool LogicalXor2(unsigned long long a, unsigned long long b)
{
  if(a^b)
    return true;
  else
...
__getSuiteName(void)
{
  return "logical_ops_type_unsigned_long_long";
}
