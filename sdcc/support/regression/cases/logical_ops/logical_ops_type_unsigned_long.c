...
bool LogicalOr1(unsigned long a, unsigned long b)
{
  return (a||b);
}

bool LogicalOr2(unsigned long a, unsigned long b)
{
  if(a|b)
    return true;
  else
...
bool LogicalAnd1(unsigned long a, unsigned long b)
{
  return (a&&b);
}

bool LogicalAnd2(unsigned long a, unsigned long b)
{
  if(a&b)
    return true;
  else
...
bool LogicalXor2(unsigned long a, unsigned long b)
{
  if(a^b)
    return true;
  else
...
__getSuiteName(void)
{
  return "logical_ops_type_unsigned_long";
}
