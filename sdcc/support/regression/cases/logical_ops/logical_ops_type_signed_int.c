...
bool LogicalOr1(signed int a, signed int b)
{
  return (a||b);
}

bool LogicalOr2(signed int a, signed int b)
{
  if(a|b)
    return true;
  else
...
bool LogicalAnd1(signed int a, signed int b)
{
  return (a&&b);
}

bool LogicalAnd2(signed int a, signed int b)
{
  if(a&b)
    return true;
  else
...
bool LogicalXor2(signed int a, signed int b)
{
  if(a^b)
    return true;
  else
...
__getSuiteName(void)
{
  return "logical_ops_type_signed_int";
}
