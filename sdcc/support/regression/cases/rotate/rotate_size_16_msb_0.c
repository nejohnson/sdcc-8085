...
#  if MSB
#    define TEST_VECT 0xa8c5a5c655357553
#  else
#    define TEST_VECT 0x55357553a8c5a5c6
#  endif
#endif
...
#if (!defined(__SDCC_hc08) && !defined(__SDCC_s08)) || SIZE < 32 // RFE #1013
#if SIZE >=32
...
testRol(void)
{
#if (!defined(__SDCC_ds390) && !defined(__SDCC_hc08) && !defined(__SDCC_s08)) || SIZE < 32 // Bug #3928, RFE #1013
