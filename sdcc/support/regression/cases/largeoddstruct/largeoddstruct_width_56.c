...
#if __SDCC_BITINT_MAXWIDTH >= 56 // TODO: When we can regression-test in --std-c23 mode, use the standard macro from limits.h instead!
...
__getSuiteName(void)
{
  return "largeoddstruct_width_56";
}
