...
unsigned long add_bc(unsigned long a, unsigned long b)
{
	unsigned long r = a + b;
...
unsigned long add_de(unsigned long a, unsigned long b)
{
	unsigned long r = a + b;
...
unsigned long add_hl(unsigned long a, unsigned long b)
{
	unsigned long r = a + b;
...
unsigned long add_iy(unsigned long a, unsigned long b)
{
	unsigned long r = a + b;
...
{
#if defined(__SDCC_z80) || defined(__SDCC_z80n) || defined(__SDCC_z180) || defined(__SDCC_r2k) || defined(__SDCC_r2ka) || defined(__SDCC_r3ka) || defined(__SDCC_r4k) || defined(__SDCC_r5k) || defined(__SDCC_r6k) || defined(__SDCC_tlcs90) || defined(__SDCC_ez80)
	ASSERT(add_bc(0x55, 0xaa) == (unsigned long)(0x55 + 0xaa));
	ASSERT(add_de(0x55, 0xaa) == (unsigned long)(0x55 + 0xaa));
	ASSERT(add_hl(0x55, 0xaa) == (unsigned long)(0x55 + 0xaa));
	ASSERT(add_iy(0x55, 0xaa) == (unsigned long)(0x55 + 0xaa));
#endif
}
...
__getSuiteName(void)
{
  return "preserves_regs_type_unsigned_long";
}
