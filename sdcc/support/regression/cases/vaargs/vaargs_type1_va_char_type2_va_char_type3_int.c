...
testArgs(void)
{
    ...
    ASSERT(returnSecondArgCopy(marker, (va_char)1, (va_char)-23, (int)64) == (va_char)-23);
    ASSERT(returnSecondArgCopy(marker, (va_char)1, (va_char)8, (int)64) == (va_char)8);
...
__getSuiteName(void)
{
  return "vaargs_type1_va_char_type2_va_char_type3_int";
}
