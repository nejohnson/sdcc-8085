...
testArgs(void)
{
    ...
    ASSERT(returnSecondArgCopy(marker, (int)1, (va_char)-23, (int)64) == (va_char)-23);
    ASSERT(returnSecondArgCopy(marker, (int)1, (va_char)8, (int)64) == (va_char)8);
...
__getSuiteName(void)
{
  return "vaargs_type1_int_type2_va_char_type3_int";
}
