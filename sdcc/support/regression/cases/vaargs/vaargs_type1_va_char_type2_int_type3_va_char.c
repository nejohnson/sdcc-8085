...
testArgs(void)
{
    ...
    ASSERT(returnSecondArgCopy(marker, (va_char)1, (int)-23, (va_char)64) == (int)-23);
    ASSERT(returnSecondArgCopy(marker, (va_char)1, (int)8, (va_char)64) == (int)8);
...
__getSuiteName(void)
{
  return "vaargs_type1_va_char_type2_int_type3_va_char";
}
