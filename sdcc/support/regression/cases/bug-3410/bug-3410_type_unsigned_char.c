...
#if defined(__SDCC) && !defined(__SDCC_hc08) && !defined(__SDCC_s08) // Lack of _BitInt support for hc08 and s08.
...
bool test( unsigned char c, const Part *part ) {
...
__getSuiteName(void)
{
  return "bug-3410_type_unsigned_char";
}
