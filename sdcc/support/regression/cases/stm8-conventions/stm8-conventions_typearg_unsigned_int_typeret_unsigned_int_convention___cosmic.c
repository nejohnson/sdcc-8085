...
#ifdef __SDCC_stm8
unsigned int f(unsigned int i) __cosmic
{
	return ++i;
}

unsigned int g(unsigned int i, unsigned int j) __cosmic
{
	return i + j;
}

unsigned int h(unsigned int i, unsigned int j, unsigned long long k) __cosmic
{
	return i + j + k;
}
...
unsigned int f_wrap___cosmic(unsigned int i) __cosmic
{
	return f(i);
}
#endif
...
__getSuiteName(void)
{
  return "stm8-conventions_typearg_unsigned_int_typeret_unsigned_int_convention___cosmic";
}
