...
#if __SDCC_BITINT_MAXWIDTH >= 63 && !defined(__SDCC_pdk13) && (32 >= 63 || !defined(__SDCC_pdk14)) // Lack of memory on pdk14 for wider types. Maybe some future optimization will help here.
...
__getSuiteName(void)
{
  return "bitintfromfloat_width_63_sign_unsigned";
}
