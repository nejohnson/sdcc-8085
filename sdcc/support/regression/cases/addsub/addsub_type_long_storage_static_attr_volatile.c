...
testAdd(void)
{
  ...
  result = left + right;
  ASSERT(result == (long)(0x5500 + 0x0a00));
  ...
  ASSERT(result == (long)(0x550000ul + 0x0a0000ul));

  ASSERT(add_func(0) == (long)(5ul << 16));
#endif
}
...
__getSuiteName(void)
{
  return "addsub_type_long_storage_static_attr_volatile";
}
