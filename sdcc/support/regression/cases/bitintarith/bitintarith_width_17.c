...
#if __SDCC_BITINT_MAXWIDTH >= 17 // TODO: When we can regression-test in --std-c23 mode, use the standard macro from limits.h instead!
#if 17 <= 40 || !defined (__SDCC_pdk14) // Lack of memory

typedef _BitInt(17) bitinttype;

typedef unsigned _BitInt(17) ubitinttype;
...
void testBitIntArith(void)
{
...
#if __SDCC_BITINT_MAXWIDTH >= 17 // TODO: When we can regression-test in --std-c23 mode, use the standard macro from limits.h instead!
#if (17 <= 40 || !defined (__SDCC_pdk14)) && (17 <= 48 || !defined (__SDCC_pdk15)) // Lack of memory
...
#if 17 >= 8 // Signed overflow is undefined behaviour	
...
#if 17 >= 11 // Signed overflow is undefined behaviour
	ASSERT(a * b == (bitinttype)(23) * (bitinttype)(-42));
#endif
	...
	ua = 1ull << (17 - 1);
	ASSERT(ua / 4 == (1ull << (17 - 1)) / 4ull); // Underlying issue of bug #3855: a signed division was used for some unsigned _BitInt divisions.
#endif
#endif
#endif
#endif
