...
{
	ASSERT (callee(1, (unsigned int)0xa0 + ((unsigned int)0x01 << 8)) == (unsigned int)0xa0 + ((unsigned int)0x01 << 8));
	ASSERT (callee(2, (unsigned int)0xa0, (unsigned int)0x01) == (unsigned int)0xa0 + ((unsigned int)0x01 << 8));
}
...
__getSuiteName(void)
{
  return "argval_val1_0x01_val0_0xa0";
}
