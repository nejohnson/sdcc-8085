...
{
	ASSERT (callee(1, (unsigned int)0x00 + ((unsigned int)0x00 << 8)) == (unsigned int)0x00 + ((unsigned int)0x00 << 8));
	ASSERT (callee(2, (unsigned int)0x00, (unsigned int)0x00) == (unsigned int)0x00 + ((unsigned int)0x00 << 8));
}
...
__getSuiteName(void)
{
  return "argval_val1_0x00_val0_0x00";
}
