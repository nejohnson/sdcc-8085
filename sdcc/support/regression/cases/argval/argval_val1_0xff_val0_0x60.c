...
{
	ASSERT (callee(1, (unsigned int)0x60 + ((unsigned int)0xff << 8)) == (unsigned int)0x60 + ((unsigned int)0xff << 8));
	ASSERT (callee(2, (unsigned int)0x60, (unsigned int)0xff) == (unsigned int)0x60 + ((unsigned int)0xff << 8));
}
...
__getSuiteName(void)
{
  return "argval_val1_0xff_val0_0x60";
}
