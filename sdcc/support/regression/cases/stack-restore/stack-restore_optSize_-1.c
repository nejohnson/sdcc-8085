...
// It must assign global variable from input param and return 0
...
#if !( (defined (__SDCC_mos6502) || defined(__SDCC_mos65c02 )) && defined(__SDCC_STACK_AUTO) ) // stack too small
...
__runSuite(void)
{
  __prints("Running testStackRestore\n");
  testStackRestore();
}
...
__getSuiteName(void)
{
  return "stack-restore_optSize_-1";
}
