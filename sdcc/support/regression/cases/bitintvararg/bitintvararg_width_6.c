...
#if __SDCC_BITINT_MAXWIDTH >= 6 // TODO: When we can regression-test in --std-c23 mode, use the standard macro from limits.h instead!
...
{
#if __SDCC_BITINT_MAXWIDTH >= 6 // TODO: When we can regression-test in --std-c23 mode, use the standard macro from limits.h instead!
#if !defined(__SDCC_mcs51) || 6 != 33 // Bug #3363
    int marker = 12;
