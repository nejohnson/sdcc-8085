...
typedef void (*ONEARGFUNPTR)(int) __reentrant;
typedef long int (*FOURARGFUNPTR)(char, char, long int, long int) __reentrant;
typedef int (*TYPEFUNPTR)(int, int) __reentrant;
...
int f_ret(int arg1, int arg2) __reentrant
{
  int local;
  local = !arg1;
  return (local & arg2);
