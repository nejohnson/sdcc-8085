...
typedef void (*ONEARGFUNPTR)(bool) __reentrant;
typedef long int (*FOURARGFUNPTR)(char, char, long int, long int) __reentrant;
typedef bool (*TYPEFUNPTR)(bool, bool) __reentrant;
...
bool f_ret(bool arg1, bool arg2) __reentrant
{
  bool local;
  local = !arg1;
  return (local & arg2);
