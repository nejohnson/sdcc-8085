/*
   ...
   Test uses the implementation from tinyaes.
*/

#include <testfwk.h>

#if !defined(__SDCC_pdk13) && !defined(__SDCC_pdk14) && !defined(__SDCC_pdk15) && !defined(__SDCC_mcs51) && !( (defined (__SDCC_mos6502) || defined(__SDCC_mos65c02 )) && defined(__SDCC_STACK_AUTO) ) // Lack of memory
#define ECB 1
#define AES256 1
...
void encrypt_ecb(void)
{
    ...
    ASSERT (0 == memcmp((char*) out, (char*) in, 16));
}
#endif
...
#endif // Disable everything until here for some targets with too little memory
...
__getSuiteName(void)
{
  return "tinyaes_mode_ECB_keylen_256";
}
