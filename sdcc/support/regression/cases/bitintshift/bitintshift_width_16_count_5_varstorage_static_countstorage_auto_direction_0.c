...
{
	volatile counttype tmp = 5;
	return(tmp);
}

void testleftshift(void)
{
#if 16 <= MAXWIDTH && 5 < 16 && 0 == 0
...
__getSuiteName(void)
{
  return "bitintshift_width_16_count_5_varstorage_static_countstorage_auto_direction_0";
}
