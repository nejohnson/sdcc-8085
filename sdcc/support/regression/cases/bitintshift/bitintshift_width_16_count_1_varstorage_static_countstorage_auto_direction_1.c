...
{
	volatile counttype tmp = 1;
	return(tmp);
}

void testleftshift(void)
{
#if 16 <= MAXWIDTH && 1 < 16 && 1 == 0
...
__getSuiteName(void)
{
  return "bitintshift_width_16_count_1_varstorage_static_countstorage_auto_direction_1";
}
