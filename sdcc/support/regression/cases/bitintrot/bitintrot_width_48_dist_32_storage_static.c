...
#if __SDCC_BITINT_MAXWIDTH >= 48 && (48 <= 8 || !defined(__SDCC_pdk13) && !defined(__SDCC_pdk14)) && (48 <= 16 || !defined(__SDCC_pdk15)) // Lack of memory for pdk. TODO: When we can regression-test in --std-c23 mode, use the standard macro from limits.h instead!
...
__getSuiteName(void)
{
  return "bitintrot_width_48_dist_32_storage_static";
}
