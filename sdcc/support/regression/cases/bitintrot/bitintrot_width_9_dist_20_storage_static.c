...
#if __SDCC_BITINT_MAXWIDTH >= 9 && (9 <= 8 || !defined(__SDCC_pdk13) && !defined(__SDCC_pdk14)) && (9 <= 16 || !defined(__SDCC_pdk15)) // Lack of memory for pdk. TODO: When we can regression-test in --std-c23 mode, use the standard macro from limits.h instead!
...
__getSuiteName(void)
{
  return "bitintrot_width_9_dist_20_storage_static";
}
