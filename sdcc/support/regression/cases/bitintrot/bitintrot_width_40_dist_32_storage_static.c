...
#if __SDCC_BITINT_MAXWIDTH >= 40 && (40 <= 8 || !defined(__SDCC_pdk13) && !defined(__SDCC_pdk14)) && (40 <= 16 || !defined(__SDCC_pdk15)) // Lack of memory for pdk. TODO: When we can regression-test in --std-c23 mode, use the standard macro from limits.h instead!
typedef unsigned _BitInt(40) bitinttype;
#define WIDTH 40
#else
...
__getSuiteName(void)
{
  return "bitintrot_width_40_dist_32_storage_static";
}
