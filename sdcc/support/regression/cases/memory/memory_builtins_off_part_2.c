...
#include <string.h>
    ...
    defined(__SDCC_z80) || defined(__SDCC_z80n) || defined(__SDCC_z180) || defined(__SDCC_r2k) || defined(__SDCC_r2ka) || defined(__SDCC_r3ka) || defined(__SDCC_r4k) || defined(__SDCC_r5k) || defined(__SDCC_r6k)
#define TEST_LARGE
#endif


#define BUILTINS_off 1
...
__runSuite(void)
{
  ...
  testMemory();
  __prints("Running testLarge\n");
  testLarge();
  __prints("Running testRetVal\n");
  testRetVal();
}
...
__getSuiteName(void)
{
  return "memory_builtins_off_part_2";
}
