...
;cases/gte_pr93744-2.c:4: void __builtin_abort(void){ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr93744-2.c"
	.db 0x00
;cases/gte_pr93744-2.c:8: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_5:
	.ascii "cases/gte_pr93744-2.c"
	.db 0x00
;cases/../gte/pr93744-2.c:6: foo (int x, int y, int z)
;	genLabel
;	genFunction
;	---------------------------------
; Function foo
...
;cases/../gte/pr93744-2.c:8: int r = z - ((z - w++) & -(x < y));
;	genAssign
...
;	genMinus
	...
	sbc	a, b
	ld	d, a
;cases/../gte/pr93744-2.c:9: return r;
;	genRet
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/../gte/pr93744-2.c:10: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	pop	hl
...
; Stack space usage: 0 bytes.
_main_::
;cases/../gte/pr93744-2.c:15: w = 4;
;	genAssign
;fetchPairLong
	ld	hl, #0x0004
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(_w), hl
;cases/../gte/pr93744-2.c:16: if (foo (5, 7, 12) != 4 || w != 5)
;	genIpush
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	l, #0x0c
	push	hl
...
;	genLabel
00101$:
;cases/../gte/pr93744-2.c:17: __builtin_abort ();
;	genCall
	call	___builtin_abort
;	genLabel
00102$:
;cases/../gte/pr93744-2.c:18: if (foo (7, 5, 12) != 12 || w != 6)
;	genIpush
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, #0x000c
	push	hl
...
;	genLabel
00104$:
;cases/../gte/pr93744-2.c:19: __builtin_abort ();
;	genCall
	call	___builtin_abort
;	genLabel
00105$:
;cases/../gte/pr93744-2.c:20: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00107$.
;cases/../gte/pr93744-2.c:21: }
;	genEndFunction
	ret
;	Total main_ function size at codegen: 1 bytes.
;cases/gte_pr93744-2.c:11: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_6:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr93744-2.c:13: __code const char * __getSuiteName(void) { return "gte/pr93744-2"; }
;	genLabel
;	genFunction
;	---------------------------------
