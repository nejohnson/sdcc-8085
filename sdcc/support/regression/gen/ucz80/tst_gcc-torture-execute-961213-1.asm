...
;--------------------------------------------------------
	.module tst_gcc_torture_execute_961213_1
...
;cases/./../tests/gcc-torture-execute-961213-1.c:13: g (unsigned long long int *v, int n, unsigned int a[], int b)
;	genLabel
;	genFunction
;	---------------------------------
; Function g
...
;cases/./../tests/gcc-torture-execute-961213-1.c:16: *v = 0;
;	genPointerSet
...
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	inc	hl
	ld	(hl), a
;cases/./../tests/gcc-torture-execute-961213-1.c:17: for (cnt = 0; cnt < n; ++cnt)
;	genAssign
...
;cases/./../tests/gcc-torture-execute-961213-1.c:18: *v = *v * b + a[cnt];
;	genPointerGet
	push	bc
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	e, -2 (ix)
...
;	genLabel
00101$:
;cases/./../tests/gcc-torture-execute-961213-1.c:19: return n;
;	genRet
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	e, -4 (ix)
	ld	d, -3 (ix)
...
;cases/./../tests/gcc-torture-execute-961213-1.c:20: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	pop	hl
;	adjustStack by 4
	...
	pop	af
	jp	(hl)
;	Total g function size at codegen: 20 bytes.
;cases/./../tests/gcc-torture-execute-961213-1.c:24: testTortureExecute (void)
;	genLabel
;	genFunction
;	---------------------------------
...
;	adjustStack by -18
	ld	hl, #-18
	add	hl, sp
;cases/./../tests/gcc-torture-execute-961213-1.c:28: unsigned int ar[] = { 10, 11, 12, 13, 14 };
;	genAddrOf
	ld	sp, hl
...
;	genMove_o size 2 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	-9 (ix), #0
; peephole 178 direct load zero constant to memory addressed by index register
;cases/./../tests/gcc-torture-execute-961213-1.c:31: res = g (&v, sizeof(ar)/sizeof(ar[0]), ar, 16);
;	genCast
...
;	genCall
	call	_g
;cases/./../tests/gcc-torture-execute-961213-1.c:32: if (v != 0xabcdeUL)
;	genCmpEq
...
00113$:
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-961213-1.c:33: ASSERT (0);
;	genPlus
...
;	genLabel
00102$:
;cases/./../tests/gcc-torture-execute-961213-1.c:35: return;
;	genRet
;	genLabel
; common peephole 159 removed unused label 00103$.
;cases/./../tests/gcc-torture-execute-961213-1.c:37: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/./../tests/gcc-torture-execute-961213-1.c"
	.db 0x00
;cases/tst_gcc-torture-execute-961213-1.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___runSuite::
;cases/tst_gcc-torture-execute-961213-1.c:6: __prints("Running testTortureExecute\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_gcc-torture-execute-961213-1.c:7: testTortureExecute();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-961213-1.c:8: }
;	genEndFunction
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/tst_gcc-torture-execute-961213-1.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_gcc-torture-execute-961213-1.c:15: return "gcc-torture-execute-961213-1.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-961213-1.c:16: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_4:
	.ascii "gcc-torture-execute-961213-1.c"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
