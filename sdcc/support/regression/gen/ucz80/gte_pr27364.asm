...
;cases/gte_pr27364.c:4: void __builtin_abort(void){ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr27364.c"
	.db 0x00
;cases/gte_pr27364.c:8: void exit__substitute(int i){ASSERT(!i); longjmp(after_main, 1);}
;	genLabel
;	genFunction
;	---------------------------------
...
___str_5:
	.ascii "cases/gte_pr27364.c"
	.db 0x00
;cases/gte_pr27364.c:12: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_8:
	.ascii "cases/gte_pr27364.c"
	.db 0x00
;cases/../gte/pr27364.c:1: int f(unsigned number_of_digits_to_use)
;	genLabel
;	genFunction
;	---------------------------------
; Function f
...
;	genReceive
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/../gte/pr27364.c:3: if (number_of_digits_to_use >1294)
;	genCmpGt
	ld	a, #0x0e
	cp	a, l
	ld	a, #0x05
...
;cases/../gte/pr27364.c:4: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
...
;	genLabel
00102$:
;cases/../gte/pr27364.c:5: return (number_of_digits_to_use * 3321928 / 1000000 + 1) /16;
;	genCast
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
00103$:
;cases/../gte/pr27364.c:6: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total f function size at codegen: 5 bytes.
;cases/../gte/pr27364.c:8: int main(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
; Stack space usage: 0 bytes.
_main_::
;cases/../gte/pr27364.c:10: if (f(11) != 2)
;	genSend
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, #0x000b
;	genCall
...
;	skipping generated iCode
;cases/../gte/pr27364.c:11: __builtin_abort ();
;	genCall
	call	___builtin_abort
;	genLabel
00102$:
;cases/../gte/pr27364.c:12: exit (0);
;	genSend
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, #0x0000
;	genCall
...
;cases/../gte/pr27364.c:13: }
;	genEndFunction
	jp	_exit__substitute
; common peephole 152 removed unused ret.
;	Total main_ function size at codegen: 1 bytes.
;cases/gte_pr27364.c:15: void __runSuite(void) { __prints("Running main\n");if(!setjmp(after_main))
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
;	genIfx
	ld	a, d
	or	a, e
;cases/gte_pr27364.c:16: main_(MAINARGS); }
;	genCall
;	genLabel
	jp	z, _main_
; common peephole 81 removed jp by using inverse jump logic
...
___str_9:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr27364.c:18: __code const char * __getSuiteName(void) { return "gte/pr27364"; }
;	genLabel
;	genFunction
;	---------------------------------
