...
;--------------------------------------------------------
	.module tst_gcc_torture_execute_loop_13
...
;cases/./../tests/gcc-torture-execute-loop-13.c:16: scale (TYPE *alpha, TYPE *x, int n)
;	genLabel
;	genFunction
;	---------------------------------
; Function scale
...
;cases/./../tests/gcc-torture-execute-loop-13.c:20: if (*alpha != 1)
;	genPointerGet
;fetchPairLong
	ld	-6 (ix), l
	ld	-5 (ix), h
...
;cases/./../tests/gcc-torture-execute-loop-13.c:21: for (i = 0, ix = 0; i < n; i++, ix += 2)
;	genAssign
...
00135$:
	jp	p, 00107$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-13.c:24: tmpr = *alpha * x[ix];
;	genPointerGet
	push	de
...
;	genMove_o size 4 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	...
	ld	h, -7 (ix)
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/gcc-torture-execute-loop-13.c:25: tmpi = *alpha * x[ix + 1];
;	genCall
	call	__mullong
;	adjustStack by 4
	pop	af
...
;	genMove_o size 4 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	...
	ld	h, -7 (ix)
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/gcc-torture-execute-loop-13.c:26: x[ix] = tmpr;
;	genCall
	call	__mullong
;	adjustStack by 4
	pop	af
...
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	bc, #0x0004
	ldir
;cases/./../tests/gcc-torture-execute-loop-13.c:27: x[ix + 1] = tmpi;
;	genPointerSet
; common peephole 50a eliminated dead pop/push de pair.
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	e, -12 (ix)
...
;	genLabel
00107$:
;cases/./../tests/gcc-torture-execute-loop-13.c:29: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	pop	hl
;	adjustStack by 2
	pop	af
	jp	(hl)
;	Total scale function size at codegen: 19 bytes.
;cases/./../tests/gcc-torture-execute-loop-13.c:33: testTortureExecute (void)
;	genLabel
;	genFunction
;	---------------------------------
...
;	adjustStack by -48
	...
	add	hl, sp
	ld	sp, hl
;cases/./../tests/gcc-torture-execute-loop-13.c:38: TYPE alpha = 2;
;	genAssign
;	genMove_o size 4 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	-6 (ix), a
	ld	-5 (ix), a
;cases/./../tests/gcc-torture-execute-loop-13.c:40: for (i = 0; i < 10; i++)
;	genAddrOf
	ld	hl, #0
	add	hl, sp
	ld	c, l
...
;	genLabel
00104$:
;cases/./../tests/gcc-torture-execute-loop-13.c:41: x[i] = i;
;	genLeftShift
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	c, 00104$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-13.c:43: scale (&alpha, x, 5);
;	genCast
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	e, c
	ld	d, b
...
;	genCall
	call	_scale
	pop	bc
;cases/./../tests/gcc-torture-execute-loop-13.c:45: if (x[9] != 18)
;	genAssign
...
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-13.c:46: ASSERT (0);
;	genPlus
...
;	genLabel
00103$:
;cases/./../tests/gcc-torture-execute-loop-13.c:48: return;
;	genRet
;	genLabel
; common peephole 159 removed unused label 00106$.
;cases/./../tests/gcc-torture-execute-loop-13.c:50: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/./../tests/gcc-torture-execute-loop-13.c"
	.db 0x00
;cases/tst_gcc-torture-execute-loop-13.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___runSuite::
;cases/tst_gcc-torture-execute-loop-13.c:6: __prints("Running testTortureExecute\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_gcc-torture-execute-loop-13.c:7: testTortureExecute();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-loop-13.c:8: }
;	genEndFunction
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/tst_gcc-torture-execute-loop-13.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_gcc-torture-execute-loop-13.c:15: return "gcc-torture-execute-loop-13.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-loop-13.c:16: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_4:
	.ascii "gcc-torture-execute-loop-13.c"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
