...
;cases/./../tests/bug-607243.c:12: void testBug(void) {
;	genLabel
;	genFunction
;	---------------------------------
; Function testBug
...
_testBug::
;cases/./../tests/bug-607243.c:13: p = &h;
...
;cases/./../tests/bug-607243.c:14: p->x = 0x45;
;	genCast
...
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	inc	hl
	ld	(hl), #0x00
;cases/./../tests/bug-607243.c:15: ASSERT(IPH_V(p)==4);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
; common peephole 1 removed dead load from b into c.
;	genMove_o size 0 result type 2 source type 1 a_dead 0 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
;	genRightShift
...
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
; common peephole 9 loaded a from c directly instead of going through d.
...
___str_1:
	...
	.db 0x00
___str_2:
	.ascii "cases/./../tests/bug-607243.c"
	.db 0x00
;cases/tst_bug-607243.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
; Stack space usage: 0 bytes.
___runSuite::
;cases/tst_bug-607243.c:6: __prints("Running testBug\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_bug-607243.c:7: testBug();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_bug-607243.c:8: }
;	genEndFunction
	jp	_testBug
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/tst_bug-607243.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_bug-607243.c:15: return "bug-607243.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
