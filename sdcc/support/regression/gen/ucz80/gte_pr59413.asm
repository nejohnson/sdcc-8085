...
;cases/gte_pr59413.c:4: void __builtin_abort(void){ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr59413.c"
	.db 0x00
;cases/gte_pr59413.c:8: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
; Stack space usage: 0 bytes.
_main_::
;cases/../gte/pr59413.c:12: for (a = 7; a <= 1; a++)
;	genAssign
;fetchPairLong
	ld	hl, #0x0007
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;cases/../gte/pr59413.c:14: char d = a;
;	genCast
;	genMove_o size 1 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, (_a+0)
;cases/../gte/pr59413.c:15: c = d;
;	genCast
...
;	skipping generated iCode
;cases/../gte/pr59413.c:19: __builtin_abort ();
;	genCall
	call	___builtin_abort
;	genLabel
00103$:
;cases/../gte/pr59413.c:20: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00107$.
;cases/../gte/pr59413.c:21: }
;	genEndFunction
	ret
;	Total main_ function size at codegen: 1 bytes.
;cases/gte_pr59413.c:11: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_6:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr59413.c:13: __code const char * __getSuiteName(void) { return "gte/pr59413"; }
;	genLabel
;	genFunction
;	---------------------------------
