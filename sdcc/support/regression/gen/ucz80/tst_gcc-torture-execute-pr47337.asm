...
;--------------------------------------------------------
	.module tst_gcc_torture_execute_pr47337
...
;cases/./../tests/gcc-torture-execute-pr47337.c:23: foo (long long x, long long y)
;	genLabel
;	genFunction
;	---------------------------------
; Function foo
...
;	adjustStack by -8
	...
	add	hl, sp
	ld	sp, hl
;cases/./../tests/gcc-torture-execute-pr47337.c:25: return x / y;
;	genIpush
...
;cases/./../tests/gcc-torture-execute-pr47337.c:26: }
;	genEndFunction
;	adjustStack by 8
...
;	adjustStack by 16
	...
	ld	sp, iy
	jp	(hl)
;	Total foo function size at codegen: 14 bytes.
;cases/./../tests/gcc-torture-execute-pr47337.c:29: bar (char x, char y)
;	genLabel
;	genFunction
;	---------------------------------
; Function bar
...
;cases/./../tests/gcc-torture-execute-pr47337.c:31: return x - y;
;	genMinus
	sub	a, l
;	genRet
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/./../tests/gcc-torture-execute-pr47337.c:32: }
;	genEndFunction
	ret
;	Total bar function size at codegen: 1 bytes.
;cases/./../tests/gcc-torture-execute-pr47337.c:35: baz (int x, int y)
;	genLabel
;	genFunction
;	---------------------------------
; Function baz
...
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	b, d
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/gcc-torture-execute-pr47337.c:37: *f = (y != (short) (y * 3));
;	genAssign
...
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
;cases/./../tests/gcc-torture-execute-pr47337.c:38: for (c = 0; c < 2; c++)
;	genAssign
...
;cases/./../tests/gcc-torture-execute-pr47337.c:40: lab:
;	genLabel
00101$:
;cases/./../tests/gcc-torture-execute-pr47337.c:41: if (d)
;	genIfx
	ld	a, (_d+1)
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	z, 00106$
;cases/./../tests/gcc-torture-execute-pr47337.c:43: if (e)
;	genIfx
	ld	a, (_e+7)
	ld	iy, #_e
	or	a, 6 (iy)
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	z, 00103$
;cases/./../tests/gcc-torture-execute-pr47337.c:44: e = 1;
;	genAssign
...
;	genLabel
00103$:
;cases/./../tests/gcc-torture-execute-pr47337.c:46: return x;
;	genRet
...
;	genLabel
00106$:
;cases/./../tests/gcc-torture-execute-pr47337.c:50: d = 1;
;	genAssign
;fetchPairLong
	ld	hl, #0x0001
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(_d), hl
;cases/./../tests/gcc-torture-execute-pr47337.c:51: goto lab;
;	genGoto
; common peephole 162 changed absolute to relative unconditional jump.
	jr	00101$
;	genLabel
00107$:
;cases/./../tests/gcc-torture-execute-pr47337.c:53: f = &d;
...
;cases/./../tests/gcc-torture-execute-pr47337.c:55: return x;
;	genRet
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	pop	de
	push	de
...
;	genLabel
00111$:
;cases/./../tests/gcc-torture-execute-pr47337.c:56: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total baz function size at codegen: 5 bytes.
;cases/./../tests/gcc-torture-execute-pr47337.c:59: fnx (unsigned long long x, int y)
;	genLabel
;	genFunction
;	---------------------------------
; Function fnx
...
_fnx:
	...
	ld	ix,	#0
	add	ix, sp
;cases/./../tests/gcc-torture-execute-pr47337.c:61: if (!y)
;	genIfx
	ld	a, 13 (ix)
	or	a, 12 (ix)
; common peephole 163 changed absolute to relative conditional jump.
	jr	nz, 00103$
;cases/./../tests/gcc-torture-execute-pr47337.c:63: b = a[b & 1];
;	genAddrOf
	ld	bc, #_a+0
;	genAnd
	ld	a, (_b+0)
...
;	_moveFrom_tpair_()
	ld	a, (hl)
	ld	(_b+1), a
;cases/./../tests/gcc-torture-execute-pr47337.c:64: b = a[b & 1];
;	genAnd
	ld	a, (_b+0)
	and	a, #0x01
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	_moveFrom_tpair_()
	ld	a, (hl)
	ld	(_b+1), a
;cases/./../tests/gcc-torture-execute-pr47337.c:65: b = a[(b ^ (x & 1)) & 1];
;	genCast
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, 4 (ix)
; common peephole 7 removed dead load from 5 (ix) into d.
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;	genAnd
	and	a, #0x01
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
...
;	_moveFrom_tpair_()
	ld	a, (hl)
	ld	(_b+1), a
;cases/./../tests/gcc-torture-execute-pr47337.c:66: b = a[(b ^ (x & 1)) & 1];
;	genAssign
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	ld	hl, (_b)
;	genXor
...
;	genLabel
00103$:
;cases/./../tests/gcc-torture-execute-pr47337.c:68: }
;	genEndFunction
	pop	ix
	pop	hl
;	adjustStack by 10
	...
	pop	af
	jp	(hl)
;	Total fnx function size at codegen: 9 bytes.
;cases/./../tests/gcc-torture-execute-pr47337.c:74: testTortureExecute (void)
;	genLabel
;	genFunction
;	---------------------------------
...
;	adjustStack by -24
	...
	add	hl, sp
	ld	sp, hl
;cases/./../tests/gcc-torture-execute-pr47337.c:77: int h = 0;
;	genAssign
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	bc, #0x0000
;cases/./../tests/gcc-torture-execute-pr47337.c:82: if (strcmp (w, "1") == 0)
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
	push	bc
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	nz, 00127$
;cases/./../tests/gcc-torture-execute-pr47337.c:83: h = 1;
;	genAssign
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	bc, #0x0001
;cases/./../tests/gcc-torture-execute-pr47337.c:85: for (i = 0; i < 256; i++)
;	genLabel
00127$:
;	skipping iCode since result will be rematerialized
;	genAssign
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;cases/./../tests/gcc-torture-execute-pr47337.c:87: for (j = 8; j > 0; j--)
;	genLabel
00125$:
;	genAssign
;	genMove_o size 1 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	c, 00108$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-pr47337.c:89: a[i] = k;
;	genLeftShift
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	ld	l, e
	ld	h, d
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	c, 00125$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-pr47337.c:91: for (i = 0; i < 8; i++)
;	skipping iCode since result will be rematerialized
;	genAssign
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
00112$:
;cases/./../tests/gcc-torture-execute-pr47337.c:92: l[i] = 0;
;	genLeftShift
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	push	de
	pop	iy
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	c, 00112$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-pr47337.c:94: d = bar (c, c);
;	genSend
	push	bc
...
;	genMove_o size 1 result type 10 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	xor	a, a
	ld	(_d+1), a
;cases/./../tests/gcc-torture-execute-pr47337.c:95: d = baz (c, 1 | foo (l[0], 10));
;	genPointerGet
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	e, -24 (ix)
	ld	a, -23 (ix)
...
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(_d), de
;cases/./../tests/gcc-torture-execute-pr47337.c:96: fnx (d, h);
;	genCast
...
;	genCall
	call	_fnx
;cases/./../tests/gcc-torture-execute-pr47337.c:97: fnx (e, h);
;	genIpush
...
;	genCall
	call	_fnx
;cases/./../tests/gcc-torture-execute-pr47337.c:99: if (d != 0)
;	genIfx
	ld	a, (_d+1)
; common peephole 54 used hl instead of iy.
; common peephole 130a removed unnecessary +0 from constant
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	z, 00107$
;cases/./../tests/gcc-torture-execute-pr47337.c:100: ASSERT (0);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00107$:
;cases/./../tests/gcc-torture-execute-pr47337.c:101: return;
;	genRet
;	genLabel
; common peephole 159 removed unused label 00114$.
;cases/./../tests/gcc-torture-execute-pr47337.c:103: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
__str_2:
	...
	.db 0x00
__str_3:
	.ascii "cases/./../tests/gcc-torture-execute-pr47337.c"
	.db 0x00
;cases/tst_gcc-torture-execute-pr47337.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
; Stack space usage: 0 bytes.
___runSuite::
;cases/tst_gcc-torture-execute-pr47337.c:6: __prints("Running testTortureExecute\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_gcc-torture-execute-pr47337.c:7: testTortureExecute();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-pr47337.c:8: }
;	genEndFunction
...
___str_4:
	...
	.db 0x0a
	.db 0x00
;cases/tst_gcc-torture-execute-pr47337.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_gcc-torture-execute-pr47337.c:15: return "gcc-torture-execute-pr47337.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-pr47337.c:16: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_5:
	.ascii "gcc-torture-execute-pr47337.c"
	.db 0x00
	.area _CODE (BANK=_CSEG)
___str_6:
	.ascii "2"
