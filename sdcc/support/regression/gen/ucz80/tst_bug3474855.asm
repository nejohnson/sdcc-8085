...
;cases/./../tests/bug3474855.c:8: float mult(float x)
;	genLabel
;	genFunction
;	---------------------------------
; Function mult
...
;cases/./../tests/bug3474855.c:10: return 0.8 * x;
;	genIpush
	push	hl
	push	de
;	genSend
...
;cases/./../tests/bug3474855.c:11: }
;	genEndFunction
	ret
;	Total mult function size at codegen: 1 bytes.
;cases/./../tests/bug3474855.c:15: testBug (void)
;	genLabel
;	genFunction
;	---------------------------------
; Function testBug
...
;	adjustStack by -5
	...
	add	hl, sp
	ld	sp, hl
;cases/./../tests/bug3474855.c:19: float result = 1e-38;
;	genAssign
...
;cases/./../tests/bug3474855.c:21: do
...
;	genLabel
00101$:
;cases/./../tests/bug3474855.c:23: ASSERT (result < 1.5e-38);
;	genPlus
...
;	genLabel
00107$:
;cases/./../tests/bug3474855.c:24: result = mult(result);    //make denormalized float
;	genSend
;	genMove_o size 4 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	pop	de
	pop	hl
...
;cases/./../tests/bug3474855.c:26: while (--i);
;	genMinus
...
;cases/./../tests/bug3474855.c:27: ASSERT (result < 1e-44);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
___str_0:
	...
	.db 0x00
___str_1:
	.ascii "result < 1.5e-38"
	.db 0x00
___str_2:
	.ascii "cases/./../tests/bug3474855.c"
	.db 0x00
___str_3:
	.ascii "result < 1e-44"
	.db 0x00
;cases/tst_bug3474855.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
; Stack space usage: 0 bytes.
___runSuite::
;cases/tst_bug3474855.c:6: __prints("Running testBug\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_bug3474855.c:7: testBug();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_bug3474855.c:8: }
;	genEndFunction
	jp	_testBug
...
___str_4:
	...
	.db 0x0a
	.db 0x00
;cases/tst_bug3474855.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_bug3474855.c:15: return "bug3474855.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
