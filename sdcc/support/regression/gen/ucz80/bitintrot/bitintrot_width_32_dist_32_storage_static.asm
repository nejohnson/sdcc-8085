...
;--------------------------------------------------------
	.module bitintrot_width_32_dist_32_storage_static
...
;--------------------------------------------------------
	...
	.area _GSFINAL
	.area _GSINIT
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:38: volatile static bitinttype t1 = TESTVECT1;
;	genAssign
...
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:39: volatile static bitinttype t2 = TESTVECT2;
;	genAssign
;	genMove_o size 4 result type 10 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:36: testRot (void)
;	genLabel
;	genFunction
;	---------------------------------
; Function testRot
...
;	adjustStack by -8
	...
	add	hl, sp
	ld	sp, hl
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:41: ASSERT (ROL (t1) == ROL (TESTVECT1));
;	genPlus
...
;	genRightShift
;	genMove_o size 4 result type 6 source type 10 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
00104$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:42: ASSERT (ROL (t2) == ROL (TESTVECT2));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00106$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:43: ASSERT (ROR (t1) == ROR (TESTVECT1));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00108$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:44: ASSERT (ROR (t2) == ROR (TESTVECT2));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00110$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:45: ASSERT (NROL (t1) == NROL (TESTVECT1));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00112$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:46: ASSERT (NROL (t2) == NROL (TESTVECT2));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00114$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:47: ASSERT (NROL2 (t1) == NROL2 (TESTVECT1));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00116$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:48: ASSERT (NROL2 (t2) == NROL2 (TESTVECT2));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00118$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:50: t1 = ROL(t1);
;	genLeftShift
...
;	genMove_o size 1 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(_testRot_t1_10000_13+3), a
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:51: t2 = ROL(t2);
;	genLeftShift
;	genMove_o size 4 result type 6 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, (_testRot_t2_10000_13+0)
	ld	-4 (ix), a
...
;	genMove_o size 1 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(_testRot_t2_10000_13+3), a
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:52: ASSERT (t1 == ROL (TESTVECT1));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00120$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:53: ASSERT (t2 == ROL (TESTVECT2));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00122$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:55: t1 = ROR(t1);
;	genRightShift
;	genMove_o size 4 result type 6 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, (_testRot_t1_10000_13+0)
	ld	-4 (ix), a
...
;	genMove_o size 1 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(_testRot_t1_10000_13+3), a
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:56: t2 = ROR(t2);
;	genRightShift
;	genMove_o size 4 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, (_testRot_t2_10000_13)
	ld	hl, (_testRot_t2_10000_13 + 2)
...
;	genMove_o size 1 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	ld	(_testRot_t2_10000_13+3), a
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:57: ASSERT (t1 == TESTVECT1);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00124$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:58: ASSERT (t2 == TESTVECT2);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00101$:
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:60: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
___str_1:
	...
	.db 0x00
___str_2:
	.ascii "cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c"
	.db 0x00
___str_3:
...
___str_13:
	.ascii "t2 == TESTVECT2"
	.db 0x00
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:64: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___runSuite::
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:66: __prints("Running testRot\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:67: testRot();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:68: }
;	genEndFunction
	jp	_testRot
...
___str_14:
	...
	.db 0x0a
	.db 0x00
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:73: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:75: return "bitintrot_width_32_dist_32_storage_static";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/bitintrot/bitintrot_width_32_dist_32_storage_static.c:76: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_15:
	.ascii "bitintrot_width_32_dist_32_storage_static"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
