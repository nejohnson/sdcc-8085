...
;cases/gte_pr40386.c:7: void exit__substitute(int i){ASSERT(!i); longjmp(after_main, 1);}
;	genLabel
;	genFunction
;	---------------------------------
...
___str_1:
	...
	.db 0x00
___str_2:
	.ascii "cases/gte_pr40386.c"
	.db 0x00
;cases/gte_pr40386.c:11: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
;	adjustStack by -17
	...
	add	hl, sp
	ld	sp, hl
;cases/../gte/pr40386.c:31: if (ROR (c, shift1) != ROR (CHAR_VALUE, SHIFT1))
;	genRightShift
...
;cases/../gte/pr40386.c:32: abort ();
;	genCall
	call	_abort
;	genLabel
00102$:
;cases/../gte/pr40386.c:34: if (ROR (c, SHIFT1) != ROR (CHAR_VALUE, SHIFT1))
;	genRightShift
	ld	a, (_c+0)
	rlca
	rlca
...
;	skipping generated iCode
;cases/../gte/pr40386.c:35: abort ();
;	genCall
	call	_abort
;	genLabel
00104$:
;cases/../gte/pr40386.c:37: if (ROR (s, shift1) != ROR (SHORT_VALUE, SHIFT1))
;	genRightShift
	ld	a, (_shift1+0)
...
;	skipping generated iCode
;cases/../gte/pr40386.c:38: abort ();
;	genCall
	call	_abort
;	genLabel
00106$:
;cases/../gte/pr40386.c:40: if (ROR (s, SHIFT1) != ROR (SHORT_VALUE, SHIFT1))
;	genRightShift
;fetchPairLong
	ld	hl, (_s)
	sra	h
...
;	skipping generated iCode
;cases/../gte/pr40386.c:41: abort ();
;	genCall
	call	_abort
;	genLabel
00108$:
;cases/../gte/pr40386.c:43: if (ROR (i, shift1) != ROR (INT_VALUE, SHIFT1))
;	genRightShift
	ld	a, (_shift1+0)
;	genMove_o size 2 result type 2 source type 10 a_dead 0 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	bc, (_i)
...
;	skipping generated iCode
;cases/../gte/pr40386.c:44: abort ();
;	genCall
	call	_abort
;	genLabel
00110$:
;cases/../gte/pr40386.c:46: if (ROR (i, SHIFT1) != ROR (INT_VALUE, SHIFT1))
;	genRightShift
;fetchPairLong
	ld	hl, (_i)
	sra	h
...
;	skipping generated iCode
;cases/../gte/pr40386.c:47: abort ();
;	genCall
	call	_abort
;	genLabel
00112$:
;cases/../gte/pr40386.c:49: if (ROR (l, shift1) != ROR (LONG_VALUE, SHIFT1))
;	genRightShift
	ld	a, (_shift1+0)
...
00365$:
;	skipping generated iCode
;cases/../gte/pr40386.c:50: abort ();
;	genCall
	call	_abort
;	genLabel
00114$:
;cases/../gte/pr40386.c:52: if (ROR (l, SHIFT1) != ROR (LONG_VALUE, SHIFT1))
;	genRightShift
...
00370$:
;	skipping generated iCode
;cases/../gte/pr40386.c:53: abort ();
;	genCall
	call	_abort
;	genLabel
00116$:
;cases/../gte/pr40386.c:55: if (ROR (ll, shift1) != ROR (LL_VALUE, SHIFT1))
;	genRightShift
; common peephole 53 used direct memory load instead of indirect.
	ld	a, (#_shift1 + 0)
	ld	b, a
...
00375$:
;	skipping generated iCode
;cases/../gte/pr40386.c:56: abort ();
;	genCall
	call	_abort
;	genLabel
00118$:
;cases/../gte/pr40386.c:58: if (ROR (ll, SHIFT1) != ROR (LL_VALUE, SHIFT1))
;	genRightShift
;	genMove_o size 8 result type 6 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, (_ll+0)
	ld	-17 (ix), a
...
00380$:
;	skipping generated iCode
;cases/../gte/pr40386.c:59: abort ();
;	genCall
	call	_abort
;	genLabel
00120$:
;cases/../gte/pr40386.c:61: if (ROR (ll, shift2) != ROR (LL_VALUE, SHIFT2))
;	genRightShift
; common peephole 53 used direct memory load instead of indirect.
	ld	a, (#_shift2 + 0)
	ld	b, a
...
00385$:
;	skipping generated iCode
;cases/../gte/pr40386.c:62: abort ();
;	genCall
	call	_abort
;	genLabel
00122$:
;cases/../gte/pr40386.c:64: if (ROR (ll, SHIFT2) != ROR (LL_VALUE, SHIFT2))
;	genRightShift
;	genMove_o size 8 result type 6 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, (_ll+0)
	ld	-17 (ix), a
...
00390$:
;	skipping generated iCode
;cases/../gte/pr40386.c:65: abort ();
;	genCall
	call	_abort
;	genLabel
00124$:
;cases/../gte/pr40386.c:67: if (ROL (c, shift1) != ROL (CHAR_VALUE, SHIFT1))
;	genCast
;	genMove_o size 1 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, (_c)
...
;	skipping generated iCode
;cases/../gte/pr40386.c:68: abort ();
;	genCall
	call	_abort
;	genLabel
00126$:
;cases/../gte/pr40386.c:70: if (ROL (c, SHIFT1) != ROL (CHAR_VALUE, SHIFT1))
;	genCast
;	genMove_o size 1 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, (_c)
;	genMove_o size 1 result type 2 source type 1 a_dead 0 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	skipping generated iCode
;cases/../gte/pr40386.c:71: abort ();
;	genCall
	call	_abort
;	genLabel
00128$:
;cases/../gte/pr40386.c:73: if (ROL (s, shift1) != ROL (SHORT_VALUE, SHIFT1))
;	genLeftShift
; common peephole 53 used direct memory load instead of indirect.
	ld	a, (#_shift1 + 0)
	ld	b, a
...
;	skipping generated iCode
;cases/../gte/pr40386.c:74: abort ();
;	genCall
	call	_abort
;	genLabel
00130$:
;cases/../gte/pr40386.c:76: if (ROL (s, SHIFT1) != ROL (SHORT_VALUE, SHIFT1))
;	genLeftShift
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (_s)
	add	hl, hl
...
;	skipping generated iCode
;cases/../gte/pr40386.c:77: abort ();
;	genCall
	call	_abort
;	genLabel
00132$:
;cases/../gte/pr40386.c:79: if (ROL (i, shift1) != ROL (INT_VALUE, SHIFT1))
;	genLeftShift
; common peephole 53 used direct memory load instead of indirect.
	ld	a, (#_shift1 + 0)
	ld	b, a
...
;	skipping generated iCode
;cases/../gte/pr40386.c:80: abort ();
;	genCall
	call	_abort
;	genLabel
00134$:
;cases/../gte/pr40386.c:82: if (ROL (i, SHIFT1) != ROL (INT_VALUE, SHIFT1))
;	genLeftShift
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (_i)
	add	hl, hl
...
;	skipping generated iCode
;cases/../gte/pr40386.c:83: abort ();
;	genCall
	call	_abort
;	genLabel
00136$:
;cases/../gte/pr40386.c:85: if (ROL (l, shift1) != ROL (LONG_VALUE, SHIFT1))
;	genLeftShift
	ld	a, (_shift1+0)
	push	af
;	genMove_o size 4 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	skipping generated iCode
;cases/../gte/pr40386.c:86: abort ();
;	genCall
	call	_abort
;	genLabel
00138$:
;cases/../gte/pr40386.c:88: if (ROL (l, SHIFT1) != ROL (LONG_VALUE, SHIFT1))
;	genLeftShift
...
;	skipping generated iCode
;cases/../gte/pr40386.c:89: abort ();
;	genCall
	call	_abort
;	genLabel
00140$:
;cases/../gte/pr40386.c:91: if (ROL (ll, shift1) != ROL (LL_VALUE, SHIFT1))
;	genLeftShift
; common peephole 53 used direct memory load instead of indirect.
	ld	a, (#_shift1 + 0)
	ld	b, a
...
00423$:
;	skipping generated iCode
;cases/../gte/pr40386.c:92: abort ();
;	genCall
	call	_abort
;	genLabel
00142$:
;cases/../gte/pr40386.c:94: if (ROL (ll, SHIFT1) != ROL (LL_VALUE, SHIFT1))
;	genLeftShift
;	genMove_o size 8 result type 6 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, (_ll+0)
	ld	-17 (ix), a
...
00428$:
;	skipping generated iCode
;cases/../gte/pr40386.c:95: abort ();
;	genCall
	call	_abort
;	genLabel
00144$:
;cases/../gte/pr40386.c:97: if (ROL (ll, shift2) != ROL (LL_VALUE, SHIFT2))
;	genLeftShift
; common peephole 53 used direct memory load instead of indirect.
	ld	a, (#_shift2 + 0)
	ld	b, a
...
00433$:
;	skipping generated iCode
;cases/../gte/pr40386.c:98: abort ();
;	genCall
	call	_abort
;	genLabel
00146$:
;cases/../gte/pr40386.c:100: if (ROL (ll, SHIFT2) != ROL (LL_VALUE, SHIFT2))
;	genLeftShift
;	genMove_o size 1 result type 6 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, (_ll+0)
	ld	-10 (ix), a
...
00438$:
;	skipping generated iCode
;cases/../gte/pr40386.c:101: abort ();
;	genCall
	call	_abort
;	genLabel
00148$:
;cases/../gte/pr40386.c:103: exit (0);
;	genSend
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, #0x0000
;	genCall
...
;cases/../gte/pr40386.c:104: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total main_ function size at codegen: 5 bytes.
;cases/gte_pr40386.c:14: void __runSuite(void) { __prints("Running main\n");if(!setjmp(after_main))
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
;	genIfx
	ld	a, d
	or	a, e
;cases/gte_pr40386.c:15: main_(MAINARGS); }
;	genCall
;	genLabel
	jp	z, _main_
; common peephole 81 removed jp by using inverse jump logic
...
___str_6:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr40386.c:17: __code const char * __getSuiteName(void) { return "gte/pr40386"; }
;	genLabel
;	genFunction
;	---------------------------------
