...
;cases/gte_pr102134.c:4: void __builtin_abort(void){ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr102134.c"
	.db 0x00
;cases/gte_pr102134.c:8: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_5:
	.ascii "cases/gte_pr102134.c"
	.db 0x00
;cases/../gte/pr102134.c:8: foo (u64 a, u64 b, u64 c, u64 *r)
;	genLabel
;	genFunction
;	---------------------------------
; Function foo
...
;	genAssign
	...
	ld	bc, #8
	ldir
;cases/../gte/pr102134.c:11: u64 x = a && ((b >> (c & 63)) | ((b << (c & 63)) & g));
;	genIfx
	ld	a, 11 (ix)
	or	a, 10 (ix)
	or	a, 9 (ix)
...
;	adjustStack by 26
	...
	ld	sp, iy
	jp	(hl)
;	Total foo function size at codegen: 35 bytes.
;cases/../gte/pr102134.c:16: main ()
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
;	adjustStack by -8
	ld	hl, #-8
	add	hl, sp
;cases/../gte/pr102134.c:19: foo (1, 3000, 0, &x);
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genIpush
...
;	genCall
	call	_foo
;cases/../gte/pr102134.c:20: if (x != 2)
;	genCmpEq
...
;cases/../gte/pr102134.c:21: __builtin_abort ();
;	genCall
	call	___builtin_abort
;	genLabel
00102$:
;cases/../gte/pr102134.c:22: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00103$.
;cases/../gte/pr102134.c:23: }
;	genEndFunction
;	adjustStack by 8
	pop	af
	pop	af
...
;cases/gte_pr102134.c:11: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_6:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr102134.c:13: __code const char * __getSuiteName(void) { return "gte/pr102134"; }
;	genLabel
;	genFunction
;	---------------------------------
