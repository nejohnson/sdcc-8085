...
;cases/float/float_operation_SUB.c:64: compare (float is, float should)
;	genLabel
;	genFunction
;	---------------------------------
; Function compare
...
;cases/float/float_operation_SUB.c:66: float diff = should ? is / should : 0;
;	genIfx
	ld	a, 7 (ix)
	res	7, a
	or	a, 6 (ix)
...
;cases/float/float_operation_SUB.c:67: tests++;
;	genPlus
...
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	ld	(_tests), hl
;cases/float/float_operation_SUB.c:70: if (should == 0)
;	genIfx
	ld	a, 7 (ix)
	res	7, a
	or	a, 6 (ix)
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	nz, 00102$
;cases/float/float_operation_SUB.c:73: return 0;
;	genRet
...
;	genLabel
00102$:
;cases/float/float_operation_SUB.c:80: ASSERT (1);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	ld	iy, (___numTests)
	inc	iy
;cases/float/float_operation_SUB.c:77: if (diff > 0.999999 && diff < 1.00001)
;	genIpush
	push	bc
	push	de
	push	iy
...
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(___numTests), iy
;cases/float/float_operation_SUB.c:81: return 0;
;	genRet
;	genMove_o size 1 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	xor	a, a
; common peephole 162 changed absolute to relative unconditional jump.
...
;	genLabel
00104$:
;cases/float/float_operation_SUB.c:85: errors++;
;	genPlus
...
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(_errors), hl
;cases/float/float_operation_SUB.c:87: ASSERT (0);
;	genAssign
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(___numTests), iy
...
;	genCall
	call	___fail
;cases/float/float_operation_SUB.c:88: return 1;
;	genRet
;	genMove_o size 1 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, #0x01
;	genLabel
00107$:
;cases/float/float_operation_SUB.c:90: }
;	genEndFunction
	pop	ix
	pop	hl
;	adjustStack by 4
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/float/float_operation_SUB.c"
	.db 0x00
__str_3:
	.ascii "0"
	.db 0x00
;cases/float/float_operation_SUB.c:94: testFloatMath (void)
;	genLabel
;	genFunction
;	---------------------------------
...
;	adjustStack by -5
	...
	add	hl, sp
	ld	sp, hl
;cases/float/float_operation_SUB.c:101: for (i = 0; i < t; i++)
;	skipping iCode since result will be rematerialized
;	genAssign
...
;cases/float/float_operation_SUB.c:112: result = cases[i].left - cases[i].right;
;	genCast
...
;	genMove_o size 4 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	h, -2 (ix)
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/float/float_operation_SUB.c:114: compare (result, cases[i].sub);
;	genCall
	call	___fssub
;	genMove_o size 4 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	push	hl
...
;	genLabel
00105$:
;cases/float/float_operation_SUB.c:137: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total testFloatMath function size at codegen: 9 bytes.
;cases/float/float_operation_SUB.c:140: testFloatMulRound (void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
_testFloatMulRound::
;cases/float/float_operation_SUB.c:143: right = 2.0 / 10.61;
;	genAssign
;	genMove_o size 4 result type 10 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	2 (iy), #0x41
	ld	3 (iy), #0x3e
;cases/float/float_operation_SUB.c:144: result = 10.61 * right;
;	genIpush
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (_right + 2)
	push	hl
...
;	genMove_o size 4 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(_result), de
	ld	(_result + 2), hl
;cases/float/float_operation_SUB.c:145: compare (result, 2.0);
;	genIpush
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, #0x4000
	push	hl
...
;cases/float/float_operation_SUB.c:147: }
;	genEndFunction
	ret
;	Total testFloatMulRound function size at codegen: 1 bytes.
;cases/float/float_operation_SUB.c:160: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
; Stack space usage: 0 bytes.
___runSuite::
;cases/float/float_operation_SUB.c:162: __prints("Running testFloatMath\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/float/float_operation_SUB.c:163: testFloatMath();
;	genCall
	call	_testFloatMath
;cases/float/float_operation_SUB.c:164: __prints("Running testFloatMulRound\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/float/float_operation_SUB.c:165: testFloatMulRound();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/float/float_operation_SUB.c:166: }
;	genEndFunction
...
___str_5:
	...
	.db 0x0a
	.db 0x00
;cases/float/float_operation_SUB.c:171: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/float/float_operation_SUB.c:173: return "float_operation_SUB";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/float/float_operation_SUB.c:174: }
;	genEndFunction
	ret
