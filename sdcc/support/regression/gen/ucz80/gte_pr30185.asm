...
;cases/gte_pr30185.c:7: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr30185.c"
	.db 0x00
;cases/../gte/pr30185.c:8: foo (S x, S y)
;	genLabel
;	genFunction
;	---------------------------------
; Function foo
...
;	adjustStack by -25
	...
	add	hl, sp
	ld	sp, hl
;cases/../gte/pr30185.c:11: z.b = x.b / y.b;
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genPointerGet
...
;	genMove_o size 2 result type 2 source type 8 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	bc, #0x0008
	ldir
;cases/../gte/pr30185.c:12: return z;
;	genRet
	ld	hl, #27
	add	hl, sp
	ld	e, (hl)
...
;cases/../gte/pr30185.c:16: main (void)
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
;	adjustStack by -44
	...
	add	hl, sp
	ld	sp, hl
;cases/../gte/pr30185.c:19: a.b = 32LL;
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 2 result type 2 source type 8 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	inc	hl
	ld	(hl), a
;cases/../gte/pr30185.c:20: b.b = 4LL;
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 2 result type 2 source type 8 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	inc	hl
	ld	(hl), a
;cases/../gte/pr30185.c:21: if (foo (a, b).b != 8LL)
;	genPointerPush
;	genMove_o size 2 result type 2 source type 8 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
; common peephole 120 removed loads by exploiting commutativity of addition.
; common peephole 130b added +8 to immediate 9
	ld	hl, #0x11
	add	hl, sp
	ld	b, (hl)
	dec	hl
...
;cases/../gte/pr30185.c:22: abort ();
;	genCall
	call	_abort
;	genLabel
00102$:
;cases/../gte/pr30185.c:23: a.b = -8LL;
;	genPointerSet
;	genMove_o size 2 result type 2 source type 8 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, #1
	add	hl, sp
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	inc	hl
	ld	(hl), #0xff
;cases/../gte/pr30185.c:24: b.b = -2LL;
;	genPointerSet
;	genMove_o size 2 result type 2 source type 8 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	inc	hl
	inc	hl
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	inc	hl
	ld	(hl), #0xff
;cases/../gte/pr30185.c:25: if (foo (a, b).b != 4LL)
;	genPointerPush
;	genMove_o size 2 result type 2 source type 8 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
; common peephole 120 removed loads by exploiting commutativity of addition.
...
;	skipping generated iCode
;cases/../gte/pr30185.c:26: abort ();
;	genCall
	call	_abort
;	genLabel
00104$:
;cases/../gte/pr30185.c:27: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00105$.
;cases/../gte/pr30185.c:28: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total main_ function size at codegen: 13 bytes.
;cases/gte_pr30185.c:10: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr30185.c:12: __code const char * __getSuiteName(void) { return "gte/pr30185"; }
;	genLabel
;	genFunction
;	---------------------------------
