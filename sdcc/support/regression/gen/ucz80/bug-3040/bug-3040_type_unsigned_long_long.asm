...
;--------------------------------------------------------
	.module bug_3040_type_unsigned_long_long
...
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:7: unsigned long long f(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function f
...
;	adjustStack by -8
	...
	add	hl, sp
	ld	sp, hl
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:11: return a + b;
;	genPlus
;	Shift into pair
	ld	hl, #_f_b_10000_13
;	Shift into pair
...
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:12: }
;	genEndFunction
;	adjustStack by 8
	pop	af
	pop	af
...
_f_b_10000_13:
	.byte #0x00, #0x00, #0x00, #0x00, #0x00, #0x00, #0x00, #0x00
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:14: unsigned long long g(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function g
...
;	adjustStack by -8
	...
	add	hl, sp
	ld	sp, hl
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:18: return a - b;
;	genMinus
;	Shift into pair
	ld	hl, #_g_b_10000_15
;	Shift into pair
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:19: }
;	genEndFunction
;	adjustStack by 8
	pop	af
	pop	af
...
_g_b_10000_15:
	.byte #0x00, #0x00, #0x00, #0x00, #0x00, #0x00, #0x00, #0x00
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:21: void testBug(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function testBug
...
;	adjustStack by -8
	...
	add	hl, sp
	ld	sp, hl
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:23: ASSERT(!f());
;	genPlus
...
;	genLabel
00101$:
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:24: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
___str_1:
	...
	.db 0x00
___str_2:
	.ascii "cases/bug-3040/bug-3040_type_unsigned_long_long.c"
	.db 0x00
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:28: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___runSuite::
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:30: __prints("Running testBug\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:31: testBug();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:32: }
;	genEndFunction
	jp	_testBug
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:37: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:39: return "bug-3040_type_unsigned_long_long";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/bug-3040/bug-3040_type_unsigned_long_long.c:40: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_4:
	.ascii "bug-3040_type_unsigned_long_long"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
