...
;cases/tcc_110_average.c:6: __code const char * __getSuiteName(void) { return "tcc/110_average"; }
;	genLabel
;	genFunction
;	---------------------------------
...
___numCases:
	.dw #0x0001
___str_0:
	.ascii "tcc/110_average"
	.db 0x00
;cases/../tcc/110_average.c:11: testc (stats_type *s, long long data)
;	genLabel
;	genFunction
;	---------------------------------
; Function testc
...
;cases/../tcc/110_average.c:13: s->average = (s->average * s->count + data) / (s->count + 1);
;	genCast
...
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	...
	ld	(hl), b
	pop	hl
;cases/../tcc/110_average.c:14: s->count++;
;	genPointerGet
;fetchPairLong
;	_moveFrom_tpair_()
	ld	c, (hl)
...
;	adjustStack by 8
	...
	pop	af
	jp	(hl)
;	Total testc function size at codegen: 14 bytes.
;cases/../tcc/110_average.c:17: int main (void)
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
;	adjustStack by -6
	ld	hl, #-6
	add	hl, sp
;cases/../tcc/110_average.c:21: s.average = 0;
;	genAddrOf
	ld	sp, hl
...
;	genMove_o size 4 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	-4 (ix), a
	ld	-3 (ix), a
;cases/../tcc/110_average.c:22: s.count = 0;
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 2 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	-2 (ix), a
	ld	-1 (ix), a
;cases/../tcc/110_average.c:23: testc (&s, 10);
;	genCast
...
;	genCall
	call	_testc
	pop	hl
;cases/../tcc/110_average.c:24: testc (&s, 20);
;	genIpush
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
	push	de
...
;	genCall
	call	_testc
;cases/../tcc/110_average.c:25: printf ("%g %d\n", s.average, s.count);
;	genPointerGet
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	e, -2 (ix)
	ld	d, -1 (ix)
...
;	adjustStack by 8
	...
	pop	af
	pop	af
;cases/../tcc/110_average.c:26: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/../tcc/110_average.c:27: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
___str_1:
	...
	.db 0x0a
	.db 0x00
;cases/tcc_110_average.c:13: int putchar(int c){_putchar(c);return(c);}
;	genLabel
;	genFunction
;	---------------------------------
; Function putchar
...
;cases/tcc_110_average.c:14: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_3:
	...
	.db 0x00
__str_4:
	.ascii "cases/tcc_110_average.c"
	.db 0x00
;cases/tcc_110_average.c:16: void __runSuite(void) { __prints("Running main\n"); ASSERT(!main_(MAINARGS)); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
