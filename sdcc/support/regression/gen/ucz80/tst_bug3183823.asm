...
;cases/./../tests/bug3183823.c:7: float neg (float x)
;	genLabel
;	genFunction
;	---------------------------------
; Function neg
...
;cases/./../tests/bug3183823.c:9: return -x;
;	genUminus
...
;cases/./../tests/bug3183823.c:10: }
;	genEndFunction
	ret
;	Total neg function size at codegen: 1 bytes.
;cases/./../tests/bug3183823.c:12: void testNeg (void)
;	genLabel
;	genFunction
;	---------------------------------
; Function testNeg
...
;	adjustStack by -8
	...
	add	hl, sp
	ld	sp, hl
;cases/./../tests/bug3183823.c:18: x = neg(0.0);
;	genSend
...
;cases/./../tests/bug3183823.c:19: y = neg(-0.0);
;	genSend
	push	bc
	push	de
...
;	genMove_o size 0 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	pop	de
	pop	bc
;cases/./../tests/bug3183823.c:20: ASSERT (x==0.0);
;	genPlus
...
;	genLabel
00104$:
;cases/./../tests/bug3183823.c:21: ASSERT (y==0.0);
;	genPlus
...
;	genLabel
00106$:
;cases/./../tests/bug3183823.c:22: ASSERT (x==-0.0);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00108$:
;cases/./../tests/bug3183823.c:23: ASSERT (y==-0.0);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00110$:
;cases/./../tests/bug3183823.c:24: ASSERT (x==y);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00112$:
;cases/./../tests/bug3183823.c:25: ASSERT (x>=y);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00114$:
;cases/./../tests/bug3183823.c:26: ASSERT (x<=y);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00116$:
;cases/./../tests/bug3183823.c:27: ASSERT (y>=x);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00118$:
;cases/./../tests/bug3183823.c:28: ASSERT (y<=x);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00120$:
;cases/./../tests/bug3183823.c:30: a = ((char*)&x)[0];
;	skipping iCode since result will be rematerialized
;	genPointerGet
;	genMove_o size 1 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	c, -8 (ix)
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/bug3183823.c:31: b = ((char*)&x)[3];
;	skipping iCode since result will be rematerialized
;	genPointerGet
;	genMove_o size 1 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, -5 (ix)
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/bug3183823.c:32: ((char*)&x)[0] = b;
;	genPointerSet
;	genMove_o size 1 result type 6 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	-8 (ix), a
;	genMove_o size 0 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/bug3183823.c:33: ((char*)&x)[3] = a;
;	genPointerSet
;	genMove_o size 1 result type 6 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	-5 (ix), c
;	genMove_o size 0 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/bug3183823.c:34: ASSERT (x!=0.0);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00101$:
;cases/./../tests/bug3183823.c:36: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total testNeg function size at codegen: 5 bytes.
___str_0:
...
___str_1:
	...
	.db 0x00
___str_2:
	.ascii "cases/./../tests/bug3183823.c"
	.db 0x00
___str_3:
	.ascii "y==0.0"
	.db 0x00
...
___str_11:
	.ascii "x!=0.0"
	.db 0x00
;cases/tst_bug3183823.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
; Stack space usage: 0 bytes.
___runSuite::
;cases/tst_bug3183823.c:6: __prints("Running testNeg\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_bug3183823.c:7: testNeg();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_bug3183823.c:8: }
;	genEndFunction
	jp	_testNeg
; common peephole 152 removed unused ret.
;	Total __runSuite function size at codegen: 1 bytes.
___str_12:
	.ascii "Running testNeg"
	.db 0x0a
	.db 0x00
;cases/tst_bug3183823.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_bug3183823.c:15: return "bug3183823.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
