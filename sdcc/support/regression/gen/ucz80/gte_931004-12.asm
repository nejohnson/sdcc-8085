...
;cases/gte_931004-12.c:7: void exit__substitute(int i){ASSERT(!i); longjmp(after_main, 1);}
;	genLabel
;	genFunction
;	---------------------------------
...
___str_1:
	...
	.db 0x00
___str_2:
	.ascii "cases/gte_931004-12.c"
	.db 0x00
;cases/gte_931004-12.c:11: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_5:
	.ascii "cases/gte_931004-12.c"
	.db 0x00
;cases/../gte/931004-12.c:10: f (int n, ...)
;	genLabel
;	genFunction
;	---------------------------------
; Function f
...
;	adjustStack by -5
	...
	add	hl, sp
	ld	sp, hl
;cases/../gte/931004-12.c:16: va_start (ap,n);
;	genAddrOf
	ld	hl, #11
	add	hl, sp
;	genCast
...
;cases/../gte/931004-12.c:17: for (i = 0; i < n; i++)
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genAssign
...
;cases/../gte/931004-12.c:19: x = va_arg (ap,struct tiny);
;	genCast
...
;	skipping generated iCode
;	skipping generated iCode
;cases/../gte/931004-12.c:20: if (x.c != i + 10)
;	genPointerGet
...
;	skipping generated iCode
;cases/../gte/931004-12.c:21: abort();
;	genCall
	push	bc
	call	_abort
	pop	bc
;	genLabel
00105$:
;cases/../gte/931004-12.c:22: if (x.d != i + 20)
;	genPointerGet
;	genMove_o size 1 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	e, -4 (ix)
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	skipping generated iCode
;cases/../gte/931004-12.c:23: abort();
;	genCall
	push	bc
	call	_abort
	pop	bc
;	genLabel
00107$:
;cases/../gte/931004-12.c:24: if (x.e != i + 30)
;	genPointerGet
;	genMove_o size 1 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	e, -3 (ix)
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	skipping generated iCode
;cases/../gte/931004-12.c:25: abort();
;	genCall
	push	bc
	call	_abort
	pop	bc
...
;	genLabel
00110$:
;cases/../gte/931004-12.c:28: long x = va_arg (ap, long);
;	genPlus
...
;	_moveFrom_tpair_()
	ld	d, (hl)
;cases/../gte/931004-12.c:29: if (x != 123)
;	genCmpEq
...
;	skipping generated iCode
;cases/../gte/931004-12.c:30: abort();
;	genCall
	call	_abort
;cases/../gte/931004-12.c:32: va_end (ap);
;	genLabel
00116$:
;cases/../gte/931004-12.c:33: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total f function size at codegen: 7 bytes.
;cases/../gte/931004-12.c:35: main ()
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
;	adjustStack by -9
	ld	hl, #-9
	add	hl, sp
;cases/../gte/931004-12.c:38: x[0].c = 10;
;	genAddrOf
	ld	sp, hl
; common peephole 9c reused value still in hl.
;	genPointerSet
	ld	(hl), #0x0a
;cases/../gte/931004-12.c:39: x[1].c = 11;
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	-6 (ix), #0x0b
;cases/../gte/931004-12.c:40: x[2].c = 12;
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	-3 (ix), #0x0c
;cases/../gte/931004-12.c:41: x[0].d = 20;
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	-8 (ix), #0x14
;cases/../gte/931004-12.c:42: x[1].d = 21;
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	-5 (ix), #0x15
;cases/../gte/931004-12.c:43: x[2].d = 22;
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	-2 (ix), #0x16
;cases/../gte/931004-12.c:44: x[0].e = 30;
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	-7 (ix), #0x1e
;cases/../gte/931004-12.c:45: x[1].e = 31;
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	-4 (ix), #0x1f
;cases/../gte/931004-12.c:46: x[2].e = 32;
;	skipping iCode since result will be rematerialized
;	genPointerSet
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	-1 (ix), #0x20
;cases/../gte/931004-12.c:47: f (3, x[0], x[1], x[2], (long) 123);
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genAssign
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	adjustStack by 15
	...
	add	hl, sp
	ld	sp, hl
;cases/../gte/931004-12.c:48: exit(0);
;	genSend
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, #0x0000
;	genCall
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/../gte/931004-12.c:49: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total main_ function size at codegen: 5 bytes.
;cases/gte_931004-12.c:14: void __runSuite(void) { __prints("Running main\n");if(!setjmp(after_main))
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
;	genIfx
	ld	a, d
	or	a, e
;cases/gte_931004-12.c:15: main_(MAINARGS); }
;	genCall
;	genLabel
	jp	z, _main_
; common peephole 81 removed jp by using inverse jump logic
...
___str_6:
	...
	.db 0x0a
	.db 0x00
;cases/gte_931004-12.c:17: __code const char * __getSuiteName(void) { return "gte/931004-12"; }
;	genLabel
;	genFunction
;	---------------------------------
