...
;cases/gte_pr58364.c:4: void __builtin_abort(void){ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr58364.c"
	.db 0x00
;cases/gte_pr58364.c:8: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_5:
	.ascii "cases/gte_pr58364.c"
	.db 0x00
;cases/../gte/pr58364.c:6: foo (int x)
;	genLabel
;	genFunction
;	---------------------------------
; Function foo
...
;cases/../gte/pr58364.c:8: return x < 0 ? 1 : x;
;	genCmpLt
	bit	7, h
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/../gte/pr58364.c:9: }
;	genEndFunction
	ret
;	Total foo function size at codegen: 1 bytes.
;cases/../gte/pr58364.c:12: main ()
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
; Stack space usage: 0 bytes.
_main_::
;cases/../gte/pr58364.c:14: if (foo (a > c == (b = 0)))
;	genCmpGt
;	Shift into pair
	ld	hl, #_c
	ld	a, (hl)
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	z, 00102$
;cases/../gte/pr58364.c:15: __builtin_abort ();
;	genCall
	call	___builtin_abort
;	genLabel
00102$:
;cases/../gte/pr58364.c:16: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00103$.
;cases/../gte/pr58364.c:17: }
;	genEndFunction
	ret
;	Total main_ function size at codegen: 1 bytes.
;cases/gte_pr58364.c:11: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_6:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr58364.c:13: __code const char * __getSuiteName(void) { return "gte/pr58364"; }
;	genLabel
;	genFunction
;	---------------------------------
