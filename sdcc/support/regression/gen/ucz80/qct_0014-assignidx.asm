...
;cases/qct_0014-assignidx.c:6: __code const char * __getSuiteName(void) { return "qct/0014-assignidx"; }
;	genLabel
;	genFunction
;	---------------------------------
...
___numCases:
	.dw #0x0001
___str_0:
	.ascii "qct/0014-assignidx"
	.db 0x00
;cases/../qct/0014-assignidx.c:3: main()
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
;	adjustStack by -2
	push	af
;cases/../qct/0014-assignidx.c:8: x = 1;
;	genAssign
;fetchPairLong
	ld	hl, #0x0001
...
;cases/../qct/0014-assignidx.c:9: p = &x;
;	genAddrOf
	ld	hl, #0
	add	hl, sp
;	genCast
;	(locations are the same)
;cases/../qct/0014-assignidx.c:10: p[0] = 0;
;	genPointerSet
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	inc	hl
	ld	(hl), a
;cases/../qct/0014-assignidx.c:11: return x;
;	genRet
...
;cases/qct_0014-assignidx.c:10: void __runSuite(void) { __prints("Running main\n"); ASSERT(!main_(MAINARGS)); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_3:
	...
	.db 0x00
___str_4:
	.ascii "cases/qct_0014-assignidx.c"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
