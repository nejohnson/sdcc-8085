...
;cases/tcc_05_array.c:6: __code const char * __getSuiteName(void) { return "tcc/05_array"; }
;	genLabel
;	genFunction
;	---------------------------------
...
___str_0:
	.ascii "tcc/05_array"
	.db 0x00
;cases/../tcc/05_array.c:3: int main() 
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
;	adjustStack by -20
	...
	add	hl, sp
	ld	sp, hl
;cases/../tcc/05_array.c:8: for (Count = 1; Count <= 10; Count++)
;	skipping iCode since result will be rematerialized
;	genAssign
...
;	genLabel
00103$:
;cases/../tcc/05_array.c:10: Array[Count-1] = Count * Count;
;	genCast
...
;cases/../tcc/05_array.c:13: for (Count = 0; Count < 10; Count++)
;	skipping iCode since result will be rematerialized
;	genAssign
...
;	genLabel
00105$:
;cases/../tcc/05_array.c:15: printf("%d\n", Array[Count]);
;	genLeftShift
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	l, c
	ld	h, b
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	c, 00105$
;	skipping generated iCode
;cases/../tcc/05_array.c:18: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00107$.
;cases/../tcc/05_array.c:19: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
___str_1:
	...
	.db 0x0a
	.db 0x00
;cases/tcc_05_array.c:13: int putchar(int c){_putchar(c);return(c);}
;	genLabel
;	genFunction
;	---------------------------------
; Function putchar
...
;cases/tcc_05_array.c:14: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_3:
	...
	.db 0x00
__str_4:
	.ascii "cases/tcc_05_array.c"
	.db 0x00
;cases/tcc_05_array.c:16: void __runSuite(void) { __prints("Running main\n"); ASSERT(!main_(MAINARGS)); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
