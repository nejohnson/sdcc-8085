...
;--------------------------------------------------------
	.module tst_gcc_torture_execute_loop_15
...
;cases/./../tests/gcc-torture-execute-loop-15.c:14: foo (unsigned long *start, unsigned long *end)
;	genLabel
;	genFunction
;	---------------------------------
; Function foo
...
;cases/./../tests/gcc-torture-execute-loop-15.c:16: unsigned long *temp = end - 1;
;	genMinus
	ld	a, e
	add	a, #0xfc
	ld	l, a
	...
	adc	a, #0xff
	ld	h, a
;cases/./../tests/gcc-torture-execute-loop-15.c:18: while (end > start)
;	genAssign
...
;cases/./../tests/gcc-torture-execute-loop-15.c:19: *end-- = *temp--;
;	genPointerGet
	push	hl
	push	de
	push	bc
...
;	genLabel
00104$:
;cases/./../tests/gcc-torture-execute-loop-15.c:20: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total foo function size at codegen: 13 bytes.
;cases/./../tests/gcc-torture-execute-loop-15.c:23: testTortureExecute (void)
;	genLabel
;	genFunction
;	---------------------------------
...
;	adjustStack by -36
	...
	add	hl, sp
	ld	sp, hl
;cases/./../tests/gcc-torture-execute-loop-15.c:29: for (start = 0; start < 5; start++)
...
;	genMove_o size 2 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	-16 (ix), a
	ld	-15 (ix), a
;cases/./../tests/gcc-torture-execute-loop-15.c:30: for (end = 0; end < 5; end++)
;	genLabel
00156$:
;	genLeftShift
...
;	genMove_o size 2 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	-4 (ix), a
	ld	-3 (ix), a
;cases/./../tests/gcc-torture-execute-loop-15.c:32: for (k = 0; k < 5; k++)
;	genLabel
00145$:
;	genAssign
;	genMove_o size 2 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
00113$:
;cases/./../tests/gcc-torture-execute-loop-15.c:33: a[k] = k;
;	genLeftShift
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	l, -2 (ix)
	ld	h, #0x00
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	c, 00113$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-15.c:35: foo (a + start, a + end);
;	genLeftShift
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	l, -4 (ix)
	ld	h, -3 (ix)
...
;	genCall
	call	_foo
;cases/./../tests/gcc-torture-execute-loop-15.c:37: for (k = 0; k <= start; k++)
;	genAssign
;	genMove_o size 2 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	xor	a, a
	ld	-2 (ix), a
...
00257$:
	jp	m, 00104$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-15.c:38: if (a[k] != k)
;	genLeftShift
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	l, -2 (ix)
	ld	h, -1 (ix)
...
00258$:
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-15.c:39: ASSERT (0);
;	genPlus
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	nz, 00116$
; common peephole 84 jumped to 00116$ directly instead of via 00259$.
	inc	-1 (ix)
...
;	genLabel
00104$:
;cases/./../tests/gcc-torture-execute-loop-15.c:41: for (k = start + 1; k <= end; k++)
;	genAssign
;	genMove_o size 2 result type 6 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	a, -10 (ix)
	ld	-2 (ix), a
...
00260$:
	jp	m, 00107$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-15.c:42: if (a[k] != k - 1)
;	genLeftShift
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	l, -2 (ix)
	ld	h, -1 (ix)
...
00261$:
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-15.c:43: ASSERT (0);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	nz, 00119$
; common peephole 84 jumped to 00119$ directly instead of via 00262$.
	inc	-1 (ix)
...
;	genLabel
00107$:
;cases/./../tests/gcc-torture-execute-loop-15.c:45: for (k = end + 1; k < 5; k++)
;	genPlus
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 0 iy_dead 0 f_dead 0
	ld	l, -4 (ix)
	ld	h, -3 (ix)
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	nc, 00125$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-15.c:46: if (a[k] != k)
;	genLeftShift
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	l, -2 (ix)
	ld	h, -1 (ix)
...
00263$:
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-15.c:47: ASSERT (0);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	nz, 00122$
; common peephole 84 jumped to 00122$ directly instead of via 00264$.
	inc	-1 (ix)
...
;	genCmpLt
	...
	jp	c, 00156$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-loop-15.c:50: return;
;	genRet
;	genLabel
; common peephole 159 removed unused label 00128$.
;cases/./../tests/gcc-torture-execute-loop-15.c:51: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/./../tests/gcc-torture-execute-loop-15.c"
	.db 0x00
;cases/tst_gcc-torture-execute-loop-15.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___runSuite::
;cases/tst_gcc-torture-execute-loop-15.c:6: __prints("Running testTortureExecute\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_gcc-torture-execute-loop-15.c:7: testTortureExecute();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-loop-15.c:8: }
;	genEndFunction
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/tst_gcc-torture-execute-loop-15.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_gcc-torture-execute-loop-15.c:15: return "gcc-torture-execute-loop-15.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-loop-15.c:16: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_4:
	.ascii "gcc-torture-execute-loop-15.c"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
