...
;cases/gte_pr10352-1.c:4: void __builtin_abort(void){ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr10352-1.c"
	.db 0x00
;cases/gte_pr10352-1.c:8: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_5:
	.ascii "cases/gte_pr10352-1.c"
	.db 0x00
;cases/../gte/pr10352-1.c:7: int main() {
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
; Stack space usage: 0 bytes.
_main_::
;cases/../gte/pr10352-1.c:8: d = c && (b.a = (d < 0) ^ 3);
;	genIfx
	ld	a, (_c+1)
...
;	genMove_o size 1 result type 10 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	xor	a, a
	ld	(_d+1), a
;cases/../gte/pr10352-1.c:9: if (d != 1)
;	genCmpEq
...
;cases/../gte/pr10352-1.c:10: __builtin_abort();
;	genCall
	call	___builtin_abort
;	genLabel
00102$:
;cases/../gte/pr10352-1.c:11: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00103$.
;cases/../gte/pr10352-1.c:12: }
;	genEndFunction
	ret
;	Total main_ function size at codegen: 3 bytes.
;cases/gte_pr10352-1.c:11: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_6:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr10352-1.c:13: __code const char * __getSuiteName(void) { return "gte/pr10352-1"; }
;	genLabel
;	genFunction
;	---------------------------------
