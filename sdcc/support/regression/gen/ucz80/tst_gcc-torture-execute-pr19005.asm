...
;--------------------------------------------------------
	.module tst_gcc_torture_execute_pr19005
...
;cases/./../tests/gcc-torture-execute-pr19005.c:16: bar (int a, int b)
;	genLabel
;	genFunction
;	---------------------------------
; Function bar
...
;cases/./../tests/gcc-torture-execute-pr19005.c:18: unsigned char x = v;
;	genCast
;	genMove_o size 1 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	ld	a, (_v)
;cases/./../tests/gcc-torture-execute-pr19005.c:22: if (a != x || b != (unsigned char) (x + 1))
;	genCast
...
;cases/./../tests/gcc-torture-execute-pr19005.c:23: ASSERT (0);
;	genPlus
...
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 0 iy_dead 0 f_dead 1
	ld	-1 (ix), #0x00
;cases/./../tests/gcc-torture-execute-pr19005.c:20: if (!s)
;	genIfx
	ld	a, (_s+1)
...
;	genLabel
00108$:
;cases/./../tests/gcc-torture-execute-pr19005.c:25: else if (a != (unsigned char) (x + 1) || b != x)
;	genCmpEq
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	ld	l, -2 (ix)
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
...
;	genLabel
00104$:
;cases/./../tests/gcc-torture-execute-pr19005.c:26: ASSERT (0);
;	genAssign
;fetchPairLong
	ld	l, -4 (ix)
	ld	h, -3 (ix)
...
;	genLabel
00109$:
;cases/./../tests/gcc-torture-execute-pr19005.c:27: s ^= 1;
;	genXor
	ld	a, (_s+0)
	xor	a, #0x01
...
;cases/./../tests/gcc-torture-execute-pr19005.c:28: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/./../tests/gcc-torture-execute-pr19005.c"
	.db 0x00
;cases/./../tests/gcc-torture-execute-pr19005.c:31: foo (int x)
;	genLabel
;	genFunction
;	---------------------------------
; Function foo
...
;	genReceive
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/gcc-torture-execute-pr19005.c:33: unsigned char a = x, b = x + 1;
;	genCast
...
;	genPlus
	inc	l
;cases/./../tests/gcc-torture-execute-pr19005.c:35: bar (a, b);
;	genCast
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	e, l
...
;	genCall
	...
	pop	bc
	pop	hl
;cases/./../tests/gcc-torture-execute-pr19005.c:36: a ^= b; b ^= a; a ^= b;
;	genXor
	ld	a, c
	xor	a, l
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
...
;	genXor
	xor	a, e
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
;cases/./../tests/gcc-torture-execute-pr19005.c:37: bar (a, b);
;	genCast
...
;	genCall
	call	_bar
;cases/./../tests/gcc-torture-execute-pr19005.c:38: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/./../tests/gcc-torture-execute-pr19005.c:39: }
;	genEndFunction
	ret
;	Total foo function size at codegen: 1 bytes.
;cases/./../tests/gcc-torture-execute-pr19005.c:42: testTortureExecute (void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
_testTortureExecute::
;cases/./../tests/gcc-torture-execute-pr19005.c:44: for (v = -10; v < 266; v++)
;	genAssign
;fetchPairLong
	ld	hl, #0xfff6
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
00102$:
;cases/./../tests/gcc-torture-execute-pr19005.c:45: foo (v);
;	genSend
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	c, 00102$
;	skipping generated iCode
;cases/./../tests/gcc-torture-execute-pr19005.c:46: return;
;	genRet
;	genLabel
; common peephole 159 removed unused label 00104$.
;cases/./../tests/gcc-torture-execute-pr19005.c:47: }
;	genEndFunction
	ret
;	Total testTortureExecute function size at codegen: 1 bytes.
;cases/tst_gcc-torture-execute-pr19005.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
; Stack space usage: 0 bytes.
___runSuite::
;cases/tst_gcc-torture-execute-pr19005.c:6: __prints("Running testTortureExecute\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_gcc-torture-execute-pr19005.c:7: testTortureExecute();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-pr19005.c:8: }
;	genEndFunction
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/tst_gcc-torture-execute-pr19005.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_gcc-torture-execute-pr19005.c:15: return "gcc-torture-execute-pr19005.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-pr19005.c:16: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_4:
	.ascii "gcc-torture-execute-pr19005.c"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
