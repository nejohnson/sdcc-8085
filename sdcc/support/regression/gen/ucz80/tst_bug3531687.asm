...
;cases/./../tests/bug3531687.c:12: int f(char a, char flag)
;	genLabel
;	genFunction
;	---------------------------------
; Function f
...
;cases/./../tests/bug3531687.c:14: if (a == (flag ? 1 : 0))
;	genIfx
	inc	l
	dec	l
;	genAssign
...
;cases/./../tests/bug3531687.c:15: return 0;
;	genRet
...
;	genLabel
00102$:
;cases/./../tests/bug3531687.c:16: return 1;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0001
;	genLabel
; common peephole 159 removed unused label 00103$.
;cases/./../tests/bug3531687.c:17: }
;	genEndFunction
	ret
;	Total f function size at codegen: 1 bytes.
;cases/./../tests/bug3531687.c:19: bool g(char a, bool b)
;	genLabel
;	genFunction
;	---------------------------------
; Function g
...
;	genReceive
;	genMove_o size 1 result type 2 source type 2 a_dead 0 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/bug3531687.c:21: return (a > b);
;	genCast
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	c, a
...
;cases/./../tests/bug3531687.c:22: }
;	genEndFunction
	ret
;	Total g function size at codegen: 1 bytes.
;cases/./../tests/bug3531687.c:25: testBug(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function testBug
...
; Stack space usage: 0 bytes.
_testBug::
;cases/./../tests/bug3531687.c:27: ASSERT(f(2, 1));
;	genPlus
...
;	genLabel
00104$:
;cases/./../tests/bug3531687.c:28: ASSERT(g(2, 1));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
___str_1:
	...
	.db 0x00
___str_2:
	.ascii "cases/./../tests/bug3531687.c"
	.db 0x00
___str_3:
	.ascii "g(2, 1)"
	.db 0x00
;cases/tst_bug3531687.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
; Stack space usage: 0 bytes.
___runSuite::
;cases/tst_bug3531687.c:6: __prints("Running testBug\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_bug3531687.c:7: testBug();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_bug3531687.c:8: }
;	genEndFunction
	jp	_testBug
...
___str_4:
	...
	.db 0x0a
	.db 0x00
;cases/tst_bug3531687.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_bug3531687.c:15: return "bug3531687.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
