...
;--------------------------------------------------------
	.module tst_gcc_torture_execute_pr60454
...
;cases/./../tests/gcc-torture-execute-pr60454.c:27: fake_swap32 (uint32_t in)
;	genLabel
;	genFunction
;	---------------------------------
; Function fake_swap32
; ---------------------------------
...
;cases/./../tests/gcc-torture-execute-pr60454.c:29: return fake_const_swab32 (in);
;	genAnd
...
; common peephole 12 loaded -11 (ix) into l directly instead of going through c.
	ld	l, -11 (ix)
...
;cases/./../tests/gcc-torture-execute-pr60454.c:30: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total fake_swap32 function size at codegen: 5 bytes.
;cases/./../tests/gcc-torture-execute-pr60454.c:34: testTortureExecute (void)
;	genLabel
;	genFunction
;	---------------------------------
...
_testTortureExecute::
;cases/./../tests/gcc-torture-execute-pr60454.c:39: if (fake_swap32 (0x12345678UL) != 0x78567E12UL)
;	genSend
...
;cases/./../tests/gcc-torture-execute-pr60454.c:40: ASSERT (0);
;	genPlus
...
;cases/./../tests/gcc-torture-execute-pr60454.c:42: }
;	genEndFunction
	ret
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/./../tests/gcc-torture-execute-pr60454.c"
	.db 0x00
;cases/tst_gcc-torture-execute-pr60454.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
; Stack space usage: 0 bytes.
___runSuite::
;cases/tst_gcc-torture-execute-pr60454.c:6: __prints("Running testTortureExecute\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_gcc-torture-execute-pr60454.c:7: testTortureExecute();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-pr60454.c:8: }
;	genEndFunction
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/tst_gcc-torture-execute-pr60454.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_gcc-torture-execute-pr60454.c:15: return "gcc-torture-execute-pr60454.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_gcc-torture-execute-pr60454.c:16: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_4:
	.ascii "gcc-torture-execute-pr60454.c"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
