...
;cases/./../tests/bug-2197.c:20: inttostr (long i, char buf[N])
;	genLabel
;	genFunction
;	---------------------------------
; Function inttostr
...
;cases/./../tests/bug-2197.c:22: unsigned long ui = i;
;	genAssign
...
;cases/./../tests/bug-2197.c:23: char *p = buf + (N-1);
;	genPlus
	ld	a, 4 (ix)
	add	a, #0x7f
	ld	-2 (ix), a
...
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	ld	(hl), #0x00
	pop	hl
;cases/./../tests/bug-2197.c:25: if (i < 0)
;	genCmpLt
	ld	a, h
	rlca
	and	a, #0x01
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	z, 00115$
;cases/./../tests/bug-2197.c:26: ui = -ui;
;	genUminus
	xor	a, a
	sub	a, e
	ld	-8 (ix), a
...
;	genLabel
00103$:
;cases/./../tests/bug-2197.c:28: *--p = '0' + ui % 10;
;	genMinus
	dec	de
;	genIpush
	push	bc
...
;	genMove_o size 1 result type 2 source type 2 a_dead 1 hl_dead 0 de_dead 0 iy_dead 1 f_dead 1
	ld	(de), a
;cases/./../tests/bug-2197.c:29: while ((ui /= 10) != 0);
;	genIpush
	push	bc
	push	de
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	nz, 00103$
;cases/./../tests/bug-2197.c:30: if (i < 0)
;	genAssign
...
;	genLabel
00107$:
;cases/./../tests/bug-2197.c:32: return p;
;	genRet
...
;cases/./../tests/bug-2197.c:36: testTortureExecute (void)
;	genLabel
;	genFunction
;	---------------------------------
...
;	adjustStack by -128
	ld	hl, #-128
	add	hl, sp
;cases/./../tests/bug-2197.c:41: p = inttostr (-1, buf);
...
;	genMove_o size 2 result type 2 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	...
	ld	b, d
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/./../tests/bug-2197.c:43: ASSERT(p[0] == '-');
;	genPlus
...
;	genLabel
00104$:
;cases/./../tests/bug-2197.c:44: ASSERT(p[1] == '1');
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00106$:
;cases/./../tests/bug-2197.c:45: ASSERT(p[2] == '\0');
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00108$:
;cases/./../tests/bug-2197.c:46: ASSERT(p == buf + (N-1) - 2);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00110$:
;cases/./../tests/bug-2197.c:48: return;
;	genRet
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/./../tests/bug-2197.c:50: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
...
___str_5:
	.ascii "p == buf + (N-1) - 2"
	.db 0x00
;cases/tst_bug-2197.c:4: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___runSuite::
;cases/tst_bug-2197.c:6: __prints("Running testTortureExecute\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/tst_bug-2197.c:7: testTortureExecute();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/tst_bug-2197.c:8: }
;	genEndFunction
...
___str_6:
	...
	.db 0x0a
	.db 0x00
;cases/tst_bug-2197.c:13: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/tst_bug-2197.c:15: return "bug-2197.c";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
