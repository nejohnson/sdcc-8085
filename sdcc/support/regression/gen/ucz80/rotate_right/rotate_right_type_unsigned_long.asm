...
;--------------------------------------------------------
	.module rotate_right_type_unsigned_long
...
;cases/rotate_right/rotate_right_type_unsigned_long.c:16: unsigned long ror(unsigned long v, unsigned int c)
;	genLabel
;	genFunction
;	---------------------------------
; Function ror
...
;cases/rotate_right/rotate_right_type_unsigned_long.c:18: c %= sizeof(unsigned long) * 8;
;	genAnd
	ld	a, 4 (ix)
	and	a, #0x1f
...
;	genMove_o size 1 result type 6 source type 1 a_dead 1 hl_dead 0 de_dead 0 iy_dead 1 f_dead 1
	ld	5 (ix), #0x00
;cases/rotate_right/rotate_right_type_unsigned_long.c:19: return(v >> c) | (v << (sizeof(unsigned long) * 8 - c));
;	genRightShift
	ld	a, 4 (ix)
...
;cases/rotate_right/rotate_right_type_unsigned_long.c:20: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total ror function size at codegen: 5 bytes.
;cases/rotate_right/rotate_right_type_unsigned_long.c:23: testRotateRight(void)
;	genLabel
;	genFunction
;	---------------------------------
...
;	adjustStack by -8
	...
	add	hl, sp
	ld	sp, hl
;cases/rotate_right/rotate_right_type_unsigned_long.c:26: i = 0xa5;
;	genAssign
...
; common peephole 130a removed unnecessary +0 from constant
	...
	ld	(_i+2), a
	ld	(_i+3), a
;cases/rotate_right/rotate_right_type_unsigned_long.c:27: ASSERT(stdc_rotate_right(i, 1) == ror(i, 1));
;	genPlus
...
;	genLabel
00169$:
;cases/rotate_right/rotate_right_type_unsigned_long.c:29: ASSERT(stdc_rotate_right(i, 4) == ror(i, 4));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00171$:
;cases/rotate_right/rotate_right_type_unsigned_long.c:30: ASSERT(stdc_rotate_right(i, 7) == ror(i, 7));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00173$:
;cases/rotate_right/rotate_right_type_unsigned_long.c:31: ASSERT(stdc_rotate_right(i, 8) == ror(i, 8));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;../../device/include/stdbit.h:362: inline unsigned long stdc_rotate_right_ul (unsigned long value, unsigned int count) __STDC_ROTATE_RIGHT
;	genRightShift
;	genMove_o size 3 result type 6 source type 2 a_dead 1 hl_dead 0 de_dead 1 iy_dead 1 f_dead 1
	ld	-8 (ix), b
	ld	-7 (ix), l
	ld	-6 (ix), h
...
;	genLabel
00175$:
;cases/rotate_right/rotate_right_type_unsigned_long.c:32: ASSERT(stdc_rotate_right(i, 9) == ror(i, 9));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00177$:
;cases/rotate_right/rotate_right_type_unsigned_long.c:33: ASSERT(stdc_rotate_right(i, 12) == ror(i, 12));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00179$:
;cases/rotate_right/rotate_right_type_unsigned_long.c:34: ASSERT(stdc_rotate_right(i, 15) == ror(i, 15));
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00181$:
;cases/rotate_right/rotate_right_type_unsigned_long.c:36: ASSERT(stdc_rotate_right_uc(0xa5, 4) == 0x5a);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	(___numTests), hl
;cases/rotate_right/rotate_right_type_unsigned_long.c:37: ASSERT(stdc_rotate_right_us(0xa5b6, 4) == 0x6a5b);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;cases/rotate_right/rotate_right_type_unsigned_long.c:40: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total testRotateRight function size at codegen: 14 bytes.
___str_0:
...
___str_1:
	...
	.db 0x00
___str_2:
	.ascii "cases/rotate_right/rotate_right_type_unsigned_long.c"
	.db 0x00
___str_3:
...
___str_10:
	...
	.db 0x00
;cases/rotate_right/rotate_right_type_unsigned_long.c:44: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___runSuite::
;cases/rotate_right/rotate_right_type_unsigned_long.c:46: __prints("Running testRotateRight\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/rotate_right/rotate_right_type_unsigned_long.c:47: testRotateRight();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/rotate_right/rotate_right_type_unsigned_long.c:48: }
;	genEndFunction
	jp	_testRotateRight
...
___str_11:
	...
	.db 0x0a
	.db 0x00
;cases/rotate_right/rotate_right_type_unsigned_long.c:53: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/rotate_right/rotate_right_type_unsigned_long.c:55: return "rotate_right_type_unsigned_long";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/rotate_right/rotate_right_type_unsigned_long.c:56: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_12:
	.ascii "rotate_right_type_unsigned_long"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
