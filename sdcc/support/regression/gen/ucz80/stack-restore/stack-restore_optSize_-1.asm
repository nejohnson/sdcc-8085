...
;--------------------------------------------------------
	.module stack_restore_optSize__1
...
;cases/stack-restore/stack-restore_optSize_-1.c:31: stack_restore_test_byte(const char s)
;	genLabel
;	genFunction
;	---------------------------------
...
;cases/stack-restore/stack-restore_optSize_-1.c:34: a[0] = s;
...
;cases/stack-restore/stack-restore_optSize_-1.c:35: globalValue = a[0];
;	genAssign
;	genMove_o size 1 result type 11 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, #_globalValue
	ld	(hl), c
;cases/stack-restore/stack-restore_optSize_-1.c:39: return 0;
;	genRet
;	genMove_o size 1 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	xor	a, a
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/stack-restore/stack-restore_optSize_-1.c:40: }
;	genEndFunction
;	adjustStack by 1
	inc	sp
	ret
;	Total stack_restore_test_byte function size at codegen: 2 bytes.
;cases/stack-restore/stack-restore_optSize_-1.c:51: stack_restore_test_word(void)
;	genLabel
;	genFunction
;	---------------------------------
...
;	adjustStack by -516
	...
	add	hl, sp
	ld	sp, hl
;cases/stack-restore/stack-restore_optSize_-1.c:55: uint16_t casesOk = 0;
;	genAssign
;	genMove_o size 2 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	xor	a, a
	ld	-4 (ix), a
	ld	-3 (ix), a
;cases/stack-restore/stack-restore_optSize_-1.c:57: for (i = 0; i < 256; i++)
;	skipping iCode since result will be rematerialized
;	genAssign
...
;	genLabel
00103$:
;cases/stack-restore/stack-restore_optSize_-1.c:59: x[i] = i;
;	genLeftShift
...
;	genMove_o size 2 result type 2 source type 2 a_dead 0 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	ld	(hl), e
; common peephole 10 loaded (hl) from e directly instead of going through a.
; common peephole 96b move inc hl before ld c, d
	inc	hl
; common peephole 9a loaded (hl) from d directly instead of going through c.
	ld	(hl), d
;cases/stack-restore/stack-restore_optSize_-1.c:57: for (i = 0; i < 256; i++)
;	genPlus
	inc	de
...
;cases/stack-restore/stack-restore_optSize_-1.c:61: for (i = 0; i < 256; i++)
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genAssign
...
;	genLabel
00105$:
;cases/stack-restore/stack-restore_optSize_-1.c:63: ASSERT (x[i] == i);
;	genPlus
...
;	genLabel
00110$:
;cases/stack-restore/stack-restore_optSize_-1.c:64: casesOk += x[i] == i;
;	genPointerGet
;fetchPairLong
	ld	a, (hl)
	inc	hl
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	c, 00105$
;	skipping generated iCode
;cases/stack-restore/stack-restore_optSize_-1.c:66: return casesOk;
;	genRet
;	genMove_o size 2 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	e, -4 (ix)
	ld	d, -3 (ix)
...
;cases/stack-restore/stack-restore_optSize_-1.c:67: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total test_stack_restore_word function size at codegen: 8 bytes.
___str_0:
...
___str_1:
	...
	.db 0x00
___str_2:
	.ascii "cases/stack-restore/stack-restore_optSize_-1.c"
	.db 0x00
;cases/stack-restore/stack-restore_optSize_-1.c:72: testStackRestore(void)
;	genLabel
;	genFunction
;	---------------------------------
...
_testStackRestore:
;cases/stack-restore/stack-restore_optSize_-1.c:74: globalValue = 0;
;	genAssign
;	genMove_o size 1 result type 11 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	xor	a, a
	ld	(#_globalValue), a
; common peephole 19 loaded (#_globalValue) from a directly instead of using hl.
;cases/stack-restore/stack-restore_optSize_-1.c:75: ASSERT(stack_restore_test_byte(0x5C) == 0);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00104$:
;cases/stack-restore/stack-restore_optSize_-1.c:76: ASSERT(globalValue == 0x5C);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
00106$:
;cases/stack-restore/stack-restore_optSize_-1.c:79: ASSERT(stack_restore_test_word() == 256);
;	genPlus
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (___numTests)
	inc	hl
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/stack-restore/stack-restore_optSize_-1.c:81: }
;	genEndFunction
	ret
...
___str_7:
	...
	.db 0x00
;cases/stack-restore/stack-restore_optSize_-1.c:85: __runSuite(void)
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
; Stack space usage: 0 bytes.
___runSuite::
;cases/stack-restore/stack-restore_optSize_-1.c:87: __prints("Running testStackRestore\n");
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genSend
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genCall
	call	___prints
;cases/stack-restore/stack-restore_optSize_-1.c:88: testStackRestore();
;	genCall
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/stack-restore/stack-restore_optSize_-1.c:89: }
;	genEndFunction
...
___str_8:
	...
	.db 0x0a
	.db 0x00
;cases/stack-restore/stack-restore_optSize_-1.c:94: __getSuiteName(void)
;	genLabel
;	genFunction
;	---------------------------------
...
; Stack space usage: 0 bytes.
___getSuiteName::
;cases/stack-restore/stack-restore_optSize_-1.c:96: return "stack-restore_optSize_-1";
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;	genRet
;	genMove_o size 2 result type 2 source type 7 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
; common peephole 159 removed unused label 00101$.
;cases/stack-restore/stack-restore_optSize_-1.c:97: }
;	genEndFunction
	ret
...
___numCases:
	.dw #0x0001
___str_9:
	.ascii "stack-restore_optSize_-1"
	.db 0x00
	.area _CODE (BANK=_CSEG)
	.area _INITIALIZER
	.area _CABS (ABS)
