...
;cases/gte_pr58662.c:7: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr58662.c"
	.db 0x00
;cases/../gte/pr58662.c:7: foo (int p1, short p2)
;	genLabel
;	genFunction
;	---------------------------------
; Function foo
...
;cases/../gte/pr58662.c:9: return p1 / p2;
;	genCast
...
; Stack space usage: 0 bytes.
_main_::
;cases/../gte/pr58662.c:16: d = foo (a == 0, (0, 35536)); 
;	genCmpEq
	ld	a, (_a+0)
	or	a, a
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	z, 00102$
;cases/../gte/pr58662.c:20: abort ();
;	genCall
	call	_abort
;	genLabel
00102$:
;cases/../gte/pr58662.c:21: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00103$.
;cases/../gte/pr58662.c:22: }
;	genEndFunction
	ret
;	Total main_ function size at codegen: 1 bytes.
;cases/gte_pr58662.c:10: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr58662.c:12: __code const char * __getSuiteName(void) { return "gte/pr58662"; }
;	genLabel
;	genFunction
;	---------------------------------
