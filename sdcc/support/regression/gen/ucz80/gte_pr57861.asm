...
;cases/gte_pr57861.c:7: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr57861.c"
	.db 0x00
;cases/../gte/pr57861.c:9: foo (char p)
;	genLabel
;	genFunction
;	---------------------------------
; Function foo
...
;cases/../gte/pr57861.c:12: for (c = 0; c < 2; c++)
;	genAssign
;fetchPairLong
	ld	hl, #0x0002
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;	genLabel
00106$:
;cases/../gte/pr57861.c:14: i = (j = 0) || p;
;	genAssign
;fetchPairLong
	ld	hl, #0x0000
;	genMove_o size 2 result type 10 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
...
;cases/../gte/pr57861.c:18: short *l = &f;
;	skipping iCode since result will be rematerialized
;	skipping iCode since result will be rematerialized
;cases/../gte/pr57861.c:19: a = d && h;
;	genIfx
	ld	a, (_d+1)
...
; Stack space usage: 0 bytes.
_main_::
;cases/../gte/pr57861.c:29: *g = foo (a);
;	genAssign
;	genMove_o size 2 result type 2 source type 10 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	hl, (_g)
;	genCast
...
; common peephole 163 changed absolute to relative conditional jump.
	jr	z, 00102$
;cases/../gte/pr57861.c:31: abort ();
;	genCall
	call	_abort
;	genLabel
00102$:
;cases/../gte/pr57861.c:32: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00103$.
;cases/../gte/pr57861.c:33: }
;	genEndFunction
	ret
;	Total main_ function size at codegen: 1 bytes.
;cases/gte_pr57861.c:10: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr57861.c:12: __code const char * __getSuiteName(void) { return "gte/pr57861"; }
;	genLabel
;	genFunction
;	---------------------------------
