...
;cases/gte_pr46019.c:7: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr46019.c"
	.db 0x00
;cases/../gte/pr46019.c:6: main (void)
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
;	adjustStack by -16
	...
	add	hl, sp
	ld	sp, hl
;cases/../gte/pr46019.c:10: for (n = 0; n < 8; n++)
;	genAssign
;	genMove_o size 1 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	c, #0x00
;	genLabel
00104$:
;cases/../gte/pr46019.c:11: if (l / (0x200000000ULL << n) != (0x200 >> n))
;	genLeftShift
	ld	b, c
...
;	genCmpLt
	...
	jp	c, 00104$
;	skipping generated iCode
;cases/../gte/pr46019.c:13: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00106$.
;cases/../gte/pr46019.c:14: }
;	genEndFunction
;	adjustStack by 16
	ld	hl, #16
	add	hl, sp
...
;cases/gte_pr46019.c:10: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr46019.c:12: __code const char * __getSuiteName(void) { return "gte/pr46019"; }
;	genLabel
;	genFunction
;	---------------------------------
