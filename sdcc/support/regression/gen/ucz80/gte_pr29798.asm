...
;cases/gte_pr29798.c:7: void abort(void) {ASSERT(0);}
;	genLabel
;	genFunction
;	---------------------------------
; Function abort
...
__str_1:
	...
	.db 0x00
__str_2:
	.ascii "cases/gte_pr29798.c"
	.db 0x00
;cases/../gte/pr29798.c:8: main (void)
;	genLabel
;	genFunction
;	---------------------------------
; Function main_
...
;	adjustStack by -13
	...
	add	hl, sp
	ld	sp, hl
;cases/../gte/pr29798.c:12: double beta = 0.0;
;	genAssign
...
; common peephole 174a reused value still in de.
	ld	b, d
	ld	c, e
;cases/../gte/pr29798.c:13: double work = 1.0;
;	genAssign
;	genMove_o size 4 result type 6 source type 1 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	...
	ld	-11 (ix), #0x80
	ld	-10 (ix), #0x3f
;cases/../gte/pr29798.c:14: for (i = 1; i <= 2; i++)
;	genAssign
...
;	genLabel
00106$:
;cases/../gte/pr29798.c:16: double rho = work * work;
;	genIpush
	push	bc
	push	de
...
;cases/../gte/pr29798.c:18: beta = rho / oldrho;
;	genIpush
...
;	genLabel
00102$:
;cases/../gte/pr29798.c:19: if (beta == 1.0)
;	genIpush
	push	bc
	push	de
...
;	genLabel
00104$:
;cases/../gte/pr29798.c:26: work /= 2.0;
;	genIpush
	push	bc
	push	de
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
...
;	genMove_o size 4 result type 2 source type 6 a_dead 1 hl_dead 1 de_dead 0 iy_dead 1 f_dead 1
	...
	ld	h, -10 (ix)
;	genMove_o size 0 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
;cases/../gte/pr29798.c:27: oldrho = rho;
;	genCall
	call	___fsdiv
;	genMove_o size 4 result type 6 source type 2 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	-13 (ix), e
...
;	genCmpGt
	...
	jp	nc, 00106$
;	skipping generated iCode
;cases/../gte/pr29798.c:29: return 0;
;	genRet
;	genMove_o size 2 result type 2 source type 1 a_dead 1 hl_dead 1 de_dead 1 iy_dead 1 f_dead 1
	ld	de, #0x0000
;	genLabel
; common peephole 159 removed unused label 00108$.
;cases/../gte/pr29798.c:30: }
;	genEndFunction
	ld	sp, ix
	pop	ix
	ret
;	Total main_ function size at codegen: 5 bytes.
;cases/gte_pr29798.c:10: void __runSuite(void) { __prints("Running main\n");main_(MAINARGS); }
;	genLabel
;	genFunction
;	---------------------------------
; Function __runSuite
...
___str_3:
	...
	.db 0x0a
	.db 0x00
;cases/gte_pr29798.c:12: __code const char * __getSuiteName(void) { return "gte/pr29798"; }
;	genLabel
;	genFunction
;	---------------------------------
